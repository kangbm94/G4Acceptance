...
// Sat Dec 13 14:19:37 2025 by ROOT version 6.32.04
// from TTree tpc/tree of GenfitCarbon
// found on file: /home/had/kangbm/ws/k18-analyzer/rootfiles/Geant4Prod/WeightedFermi/XiPMissProd_P_0_0_GenfitCarbonRefitXiGeant4.root
//////////////////////////////////////////////////////////

#ifndef g4refitcarbon_h
#define g4refitcarbon_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<int>     *isXiDaughter;
   vector<int>     *isXiResidual;
   Int_t           RFremain_nclTpc;
   vector<double>  *RFremain_cluster_x;
   vector<double>  *RFremain_cluster_y;
   vector<double>  *RFremain_cluster_z;
   vector<double>  *RFremain_cluster_de;
   vector<int>     *RFremain_cluster_size;
   vector<int>     *RFremain_cluster_layer;
   vector<double>  *RFremain_cluster_mrow;
   vector<int>     *RFremain_cluster_row_center;
   vector<int>     *RFremain_cluster_houghflag;
   Int_t           RFXi_nclTpc;
   vector<double>  *RFXi_cluster_x;
   vector<double>  *RFXi_cluster_y;
   vector<double>  *RFXi_cluster_z;
   vector<double>  *RFXi_cluster_de;
   vector<int>     *RFXi_cluster_size;
   vector<int>     *RFXi_cluster_layer;
   vector<double>  *RFXi_cluster_mrow;
   vector<int>     *RFXi_cluster_row_center;
   Int_t           RFntTpc;
   vector<int>     *trackmap_RF_to_Helix;
   vector<int>     *trackmap_Helix_to_RF;
   vector<int>     *RFnhtrack;
   vector<int>     *RFtrackid;
   vector<int>     *RFisXi;
   vector<int>     *RFisBeam;
   vector<int>     *RFisKurama;
   vector<int>     *RFisK18;
   vector<int>     *RFisXiDaughter;
   vector<int>     *RFisXiResidual;
   vector<int>     *RFisAccidental;
   vector<int>     *RFisMultiloop;
   vector<int>     *RFisInTarget;
   vector<int>     *RFhasNoFlag;
   vector<int>     *RFcharge;
   vector<int>     *RFpid;
   vector<double>  *RFchisqr;
   vector<double>  *RFpval;
   vector<double>  *RFpurity;
   vector<double>  *RFefficiency;
   vector<int>     *RFG4tid;
   vector<int>     *RFG4pid;
   vector<double>  *RFhelix_cx;
   vector<double>  *RFhelix_cy;
   vector<double>  *RFhelix_z0;
   vector<double>  *RFhelix_r;
   vector<double>  *RFhelix_dz;
   vector<double>  *RFtargetdist;
   vector<double>  *RFtargetdist_x;
   vector<double>  *RFtargetdist_y;
   vector<double>  *RFtargetdist_z;
   vector<double>  *RFtargetdist_t;
   vector<double>  *RFfirst_layer;
   vector<double>  *RFfirst_y;
   vector<double>  *RFlast_layer;
   vector<double>  *RFlast_y;
   vector<double>  *RFdE;
   vector<double>  *RFdEdx;
   vector<double>  *RFmom0;
   vector<double>  *RFpath;
   vector<int>     *RFisElectron;
   vector<double>  *RFnsigma_triton;
   vector<double>  *RFnsigma_deutron;
   vector<double>  *RFnsigma_proton;
   vector<double>  *RFnsigma_kaon;
   vector<double>  *RFnsigma_pion;
   vector<double>  *RFnsigma_electron;
   vector<vector<double> > *RFhitlayer;
   vector<vector<double> > *RFhitpos_x;
   vector<vector<double> > *RFhitpos_y;
   vector<vector<double> > *RFhitpos_z;
   vector<vector<double> > *RFcalpos_x;
   vector<vector<double> > *RFcalpos_y;
   vector<vector<double> > *RFcalpos_z;
   vector<vector<double> > *RFmom_x;
   vector<vector<double> > *RFmom_y;
   vector<vector<double> > *RFmom_z;
   vector<vector<double> > *RFresidual;
   vector<vector<double> > *RFresidual_x;
   vector<vector<double> > *RFresidual_y;
   vector<vector<double> > *RFresidual_z;
   vector<vector<double> > *RFresolution_x;
   vector<vector<double> > *RFresolution_y;
   vector<vector<double> > *RFresolution_z;
   vector<vector<double> > *RFhelix_t;
   vector<vector<double> > *RFpathhit;
   vector<vector<double> > *RFalpha;
   vector<vector<double> > *RFtrack_cluster_de;
   vector<vector<double> > *RFtrack_cluster_mrow;
   vector<int>     *RFchargeIndistinguishable;
   vector<double>  *RFchisqr_inverted;
   vector<double>  *RFpval_inverted;
   vector<int>     *RFcharge_inverted;
   vector<double>  *RFhelix_cx_inverted;
   vector<double>  *RFhelix_cy_inverted;
   vector<double>  *RFhelix_z0_inverted;
   vector<double>  *RFhelix_r_inverted;
   vector<double>  *RFhelix_dz_inverted;
   vector<double>  *RFmom0_inverted;
   vector<int>     *RFpid_inverted;
   vector<int>     *RFGFfitstatus;
   vector<int>     *RFGFpdgcode;
   vector<int>     *RFGFnhtrack;
   vector<double>  *RFGFcharge;
   vector<double>  *RFGFchisqr;
   vector<double>  *RFGFtof;
   vector<double>  *RFGFpval;
   vector<vector<double> > *RFGFlayer;
   vector<vector<double> > *RFGFpos_x;
   vector<vector<double> > *RFGFpos_y;
   vector<vector<double> > *RFGFpos_z;
   vector<vector<double> > *RFGFmom;
   vector<vector<double> > *RFGFmom_x;
   vector<vector<double> > *RFGFmom_y;
   vector<vector<double> > *RFGFmom_z;
   vector<vector<double> > *RFGFresidual_x;
   vector<vector<double> > *RFGFresidual_y;
   vector<vector<double> > *RFGFresidual_z;
   vector<vector<double> > *RFGFresidual_p;
   vector<vector<double> > *RFGFresidual_px;
   vector<vector<double> > *RFGFresidual_py;
   vector<vector<double> > *RFGFresidual_pz;
   vector<int>     *RFGFinside;
   Int_t           RFGFntTpc_inside;
   Double_t        RFGFprodvtx_x;
   Double_t        RFGFprodvtx_y;
   Double_t        RFGFprodvtx_z;
   vector<double>  *RFGFtracklen;
   vector<double>  *RFGFtrack2vtxdist;
   vector<double>  *RFGFcalctof;
   vector<double>  *RFGFsegHtof;
   vector<double>  *RFGFtofHtof;
   vector<double>  *RFGFtdiffHtof;
   vector<double>  *RFGFposHtof;
   vector<double>  *RFGFposx;
   vector<double>  *RFGFposy;
   vector<double>  *RFGFposz;
   vector<double>  *RFGFinvbeta;
   vector<double>  *RFGFm2;
   vector<double>  *RFnsigma_tritonHtof;
   vector<double>  *RFnsigma_deutronHtof;
   vector<double>  *RFnsigma_protonHtof;
   vector<double>  *RFnsigma_kaonHtof;
   vector<double>  *RFnsigma_pionHtof;
   vector<double>  *RFnsigma_electronHtof;
   Bool_t          RFXiflag;
   Bool_t          RFXiRefitflag;
   Bool_t          RFXiPflag;
   Double_t        RFXiMass;
   Double_t        RFXiDecayVtx_x;
   Double_t        RFXiDecayVtx_y;
   Double_t        RFXiDecayVtx_z;
   Double_t        RFXiMom;
   Double_t        RFXiMom_x;
   Double_t        RFXiMom_y;
   Double_t        RFXiMom_z;
   Double_t        RFXiVtxCloseDist;
   Double_t        RFLambdaMass;
   Double_t        RFLambdaDecayVtx_x;
   Double_t        RFLambdaDecayVtx_y;
   Double_t        RFLambdaDecayVtx_z;
   Double_t        RFLambdaMom;
   Double_t        RFLambdaMom_x;
   Double_t        RFLambdaMom_y;
   Double_t        RFLambdaMom_z;
   Double_t        RFLambdaVtxCloseDist;
   Double_t        RFXiTargetVtx_x;
   Double_t        RFXiTargetVtx_y;
   Double_t        RFXiTargetVtx_z;
   Double_t        RFXiTargetMom;
   Double_t        RFXiTargetMom_x;
   Double_t        RFXiTargetMom_y;
   Double_t        RFXiTargetMom_z;
   Double_t        RFXiTargetCloseDist_dist;
   Bool_t          RFLflag;
   Double_t        RFLambdaTargetCloseDist_dist;
   Double_t        RFLambdaTargetCloseVtx_x;
   Double_t        RFLambdaTargetCloseVtx_y;
   Double_t        RFLambdaTargetCloseVtx_z;
   Double_t        RFGFXiMass;
   Double_t        RFGFXiDecayVtx_x;
   Double_t        RFGFXiDecayVtx_y;
   Double_t        RFGFXiDecayVtx_z;
   Double_t        RFGFXiMom;
   Double_t        RFGFXiMom_x;
   Double_t        RFGFXiMom_y;
   Double_t        RFGFXiMom_z;
   Double_t        RFGFXiVtxCloseDist;
   Double_t        RFGFXiKKVtx_x;
   Double_t        RFGFXiKKVtx_y;
   Double_t        RFGFXiKKVtx_z;
   Double_t        RFGFXiKKVtxMom;
   Double_t        RFGFXiKKVtxMom_x;
   Double_t        RFGFXiKKVtxMom_y;
   Double_t        RFGFXiKKVtxMom_z;
   Double_t        RFGFXiKKVtxCloseDist;
   Double_t        RFGFXiProductionVtx_x;
   Double_t        RFGFXiProductionVtx_y;
   Double_t        RFGFXiProductionVtx_z;
   Double_t        RFGFXiProductionVtxMom;
   Double_t        RFGFXiProductionVtxMom_x;
   Double_t        RFGFXiProductionVtxMom_y;
   Double_t        RFGFXiProductionVtxMom_z;
   Double_t        RFGFXiProductionVtxCloseDist;
   Double_t        RFGFXiTrackLen;
   Double_t        RFGFXiTof;
   Double_t        RFGFXiMomLoss;
   Double_t        RFGFXiExcitation;
   Double_t        RFGFXiTarget_x;
   Double_t        RFGFXiTarget_y;
   Double_t        RFGFXiTarget_z;
   Double_t        RFGFXiTargetMom;
   Double_t        RFGFXiTargetMom_x;
   Double_t        RFGFXiTargetMom_y;
   Double_t        RFGFXiTargetMom_z;
   Double_t        RFGFXiTargetCloseDist;
   Double_t        RFGFXiTargetCenter_x;
   Double_t        RFGFXiTargetCenter_y;
   Double_t        RFGFXiTargetCenter_z;
   Double_t        RFGFXiTargetCenterMom;
   Double_t        RFGFXiTargetCenterMom_x;
   Double_t        RFGFXiTargetCenterMom_y;
   Double_t        RFGFXiTargetCenterMom_z;
   Double_t        RFGFXiTargetCenterCloseDist;
   Double_t        RFGFLambdaMass;
   Double_t        RFGFLambdaDecayVtx_x;
   Double_t        RFGFLambdaDecayVtx_y;
   Double_t        RFGFLambdaDecayVtx_z;
   Double_t        RFGFLambdaMom;
   Double_t        RFGFLambdaMom_x;
   Double_t        RFGFLambdaMom_y;
   Double_t        RFGFLambdaMom_z;
   Double_t        RFGFLambdaVtxCloseDist;
   Double_t        RFGFLambdaTargetCloseDist;
   Double_t        RFGFLambdaTarget_x;
   Double_t        RFGFLambdaTarget_y;
   Double_t        RFGFLambdaTarget_z;
   Double_t        RFGFLambdaTargetCenter_x;
   Double_t        RFGFLambdaTargetCenter_y;
   Double_t        RFGFLambdaTargetCenter_z;
   Double_t        RFGFLambdaTargetCenterCloseDist;
   Double_t        RFGFLambdaProductionVtx_x;
   Double_t        RFGFLambdaProductionVtx_y;
   Double_t        RFGFLambdaProductionVtx_z;
   Double_t        RFGFLambdaProductionVtxCloseDist;
   Double_t        RFGFLambdaTrackLen;
   Double_t        RFGFLambdaTof;
   vector<int>     *RFXiDecaysTrackId;
   vector<double>  *RFXiDecaysPurity;
   vector<double>  *RFXiDecaysEfficiency;
   vector<int>     *RFXiDecaysG4tid;
   vector<double>  *RFXiDecaysMom;
   vector<double>  *RFXiDecaysMom_x;
   vector<double>  *RFXiDecaysMom_y;
   vector<double>  *RFXiDecaysMom_z;
   vector<double>  *RFXiRefitDist_p_xz;
   vector<double>  *RFXiRefitDist_p_y;
   vector<double>  *RFXiRefitDist_pi1_xz;
   vector<double>  *RFXiRefitDist_pi1_y;
   vector<double>  *RFXiRefitDist_pi2_xz;
   vector<double>  *RFXiRefitDist_pi2_y;
   vector<double>  *RFXiRefitDist_xi_xz;
   vector<double>  *RFXiRefitDist_xi_y;
   vector<int>     *RFGFXiDecaysNhit;
   vector<double>  *RFGFXiDecaysChisqr;
   vector<double>  *RFGFXiDecaysCharge;
   vector<double>  *RFGFXiDecaysTof;
   vector<double>  *RFGFXiDecaysPval;
   vector<int>     *RFGFXiDecaysPdgcode;
   vector<int>     *RFGFXiDecaysHtofId;
   vector<double>  *RFGFXiDecaysTrackLen;
   vector<double>  *RFGFXiDecaysTrackTof;
   vector<double>  *RFGFXiDecaysMassSquare;
   vector<double>  *RFGFXiDecaysInvbeta;
   vector<double>  *RFGFXiDecaysMom;
   vector<double>  *RFGFXiDecaysMom_x;
   vector<double>  *RFGFXiDecaysMom_y;
   vector<double>  *RFGFXiDecaysMom_z;
   vector<double>  *RFGFXiDecaysMomCM;
   vector<double>  *RFGFXiDecaysMomCM_x;
   vector<double>  *RFGFXiDecaysMomCM_y;
   vector<double>  *RFGFXiDecaysMomCM_z;
   vector<double>  *RFGFXiDecaysMomLoss;
   vector<double>  *RFGFXiDecaysELoss;
   Int_t           RFAccidentalMultiplicity;
   vector<int>     *RFAccidentalTrackId;
   Int_t           RFXiResidualsMultiplicity;
   Int_t           RFXipMultiplicity;
   Int_t           RFXipipMultiplicity;
   Int_t           RFXipimMultiplicity;
   Int_t           RFXiepMultiplicity;
   Int_t           RFXiemMultiplicity;
   Int_t           RFXippipMultiplicity;
   vector<int>     *RFXiResidualsTrackId;
   vector<double>  *RFXiResidualsMassSquare;
   vector<double>  *RFXiResidualsInvbeta;
   vector<double>  *RFXiResidualsCloseDistTgt;
   vector<double>  *RFXiResidualsGFProductionVtxCloseDist;
   vector<double>  *RFXiResidualsGFProductionVtx_x;
   vector<double>  *RFXiResidualsGFProductionVtx_y;
   vector<double>  *RFXiResidualsGFProductionVtx_z;
   vector<double>  *RFXiResidualsGFProductionMom;
   vector<double>  *RFXiResidualsGFProductionMom_x;
   vector<double>  *RFXiResidualsGFProductionMom_y;
   vector<double>  *RFXiResidualsGFProductionMom_z;
   vector<double>  *RFXiResidualsKFProductionVtxCloseDist;
   vector<double>  *RFXiResidualsKFProductionVtx_x;
   vector<double>  *RFXiResidualsKFProductionVtx_y;
   vector<double>  *RFXiResidualsKFProductionVtx_z;
   vector<double>  *RFXiResidualsKFProductionMom;
   vector<double>  *RFXiResidualsKFProductionMom_x;
   vector<double>  *RFXiResidualsKFProductionMom_y;
   vector<double>  *RFXiResidualsKFProductionMom_z;
   vector<double>  *RFXiResidualsMom;
   vector<double>  *RFXiResidualsMom_x;
   vector<double>  *RFXiResidualsMom_y;
   vector<double>  *RFXiResidualsMom_z;
   vector<double>  *RFXiResidualsCharge;
   Double_t        RFKFLambdaMom;
   Double_t        RFKFLambdaMom_x;
   Double_t        RFKFLambdaMom_y;
   Double_t        RFKFLambdaMom_z;
   Double_t        RFKFLambdaChisqr;
   Double_t        RFKFLambdaPval;
   vector<double>  *RFKFLambdaPull;
   vector<vector<double> > *RFKFLambdaCovMatrix;
   Double_t        RFKFXiVtxCloseDist;
   Double_t        RFKFXiMom;
   Double_t        RFKFXiMom_x;
   Double_t        RFKFXiMom_y;
   Double_t        RFKFXiMom_z;
   Double_t        RFKFXiChisqr;
   Double_t        RFKFXiPval;
   Double_t        RFKFXiMass;
   Double_t        RFKFXiDecayVtx_x;
   Double_t        RFKFXiDecayVtx_y;
   Double_t        RFKFXiDecayVtx_z;
   vector<double>  *RFKFXiPull;
   vector<vector<double> > *RFKFXiCovMatrix;
   Double_t        RFKFKKXiProductionVtxChisqr;
   Double_t        RFKFKKXiProductionVtx_x;
   Double_t        RFKFKKXiProductionVtx_y;
   Double_t        RFKFKKXiProductionVtx_z;
   Double_t        RFKFXiProductionVtx_x;
   Double_t        RFKFXiProductionVtx_y;
   Double_t        RFKFXiProductionVtx_z;
   Double_t        RFKFXiProductionVtxMom;
   Double_t        RFKFXiProductionVtxMom_x;
   Double_t        RFKFXiProductionVtxMom_y;
   Double_t        RFKFXiProductionVtxMom_z;
   Double_t        RFKFXiProductionVtxCloseDist;
   Double_t        RFKFXiTrackLen;
   Double_t        RFKFXiTof;
   Double_t        RFKFXiMomLoss;
   Double_t        RFKFXiExcitation;
   Double_t        RFKFKpXiProductionVtx_x;
   Double_t        RFKFKpXiProductionVtx_y;
   Double_t        RFKFKpXiProductionVtx_z;
   Double_t        RFKFXiProductionVtx_x_KpXi;
   Double_t        RFKFXiProductionVtx_y_KpXi;
   Double_t        RFKFXiProductionVtx_z_KpXi;
   Double_t        RFKFXiProductionVtxMom_KpXi;
   Double_t        RFKFXiProductionVtxMom_x_KpXi;
   Double_t        RFKFXiProductionVtxMom_y_KpXi;
   Double_t        RFKFXiProductionVtxMom_z_KpXi;
   Double_t        RFKFXiProductionVtxCloseDist_KpXi;
   Double_t        RFKFXiProductionVtx_x_KK;
   Double_t        RFKFXiProductionVtx_y_KK;
   Double_t        RFKFXiProductionVtx_z_KK;
   Double_t        RFKFXiProductionVtxMom_KK;
   Double_t        RFKFXiProductionVtxMom_x_KK;
   Double_t        RFKFXiProductionVtxMom_y_KK;
   Double_t        RFKFXiProductionVtxMom_z_KK;
   Double_t        RFKFXiProductionVtxCloseDist_KK;
   vector<double>  *RFKFXiDecaysMom;
   vector<double>  *RFKFXiDecaysMom_x;
   vector<double>  *RFKFXiDecaysMom_y;
   vector<double>  *RFKFXiDecaysMom_z;
   ...
   TBranch        *b_isXiDaughter;   //!
   TBranch        *b_isXiResidual;   //!
   TBranch        *b_RFremain_nclTpc;   //!
   TBranch        *b_RFremain_cluster_x;   //!
   TBranch        *b_RFremain_cluster_y;   //!
   TBranch        *b_RFremain_cluster_z;   //!
   TBranch        *b_RFremain_cluster_de;   //!
   TBranch        *b_RFremain_cluster_size;   //!
   TBranch        *b_RFremain_cluster_layer;   //!
   TBranch        *b_RFremain_cluster_mrow;   //!
   TBranch        *b_RFremain_cluster_row_center;   //!
   TBranch        *b_RFremain_cluster_houghflag;   //!
   TBranch        *b_RFXi_nclTpc;   //!
   TBranch        *b_RFXi_cluster_x;   //!
   TBranch        *b_RFXi_cluster_y;   //!
   TBranch        *b_RFXi_cluster_z;   //!
   TBranch        *b_RFXi_cluster_de;   //!
   TBranch        *b_RFXi_cluster_size;   //!
   TBranch        *b_RFXi_cluster_layer;   //!
   TBranch        *b_RFXi_cluster_mrow;   //!
   TBranch        *b_RFXi_cluster_row_center;   //!
   TBranch        *b_RFntTpc;   //!
   TBranch        *b_trackmap_RF_to_Helix;   //!
   TBranch        *b_trackmap_Helix_to_RF;   //!
   TBranch        *b_RFnhtrack;   //!
   TBranch        *b_RFtrackid;   //!
   TBranch        *b_RFisXi;   //!
   TBranch        *b_RFisBeam;   //!
   TBranch        *b_RFisKurama;   //!
   TBranch        *b_RFisK18;   //!
   TBranch        *b_RFisXiDaughter;   //!
   TBranch        *b_RFisXiResidual;   //!
   TBranch        *b_RFisAccidental;   //!
   TBranch        *b_RFisMultiloop;   //!
   TBranch        *b_RFisInTarget;   //!
   TBranch        *b_RFhasNoFlag;   //!
   TBranch        *b_RFcharge;   //!
   TBranch        *b_RFpid;   //!
   TBranch        *b_RFchisqr;   //!
   TBranch        *b_RFpval;   //!
   TBranch        *b_RFpurity;   //!
   TBranch        *b_RFefficiency;   //!
   TBranch        *b_RFG4tid;   //!
   TBranch        *b_RFG4pid;   //!
   TBranch        *b_RFhelix_cx;   //!
   TBranch        *b_RFhelix_cy;   //!
   TBranch        *b_RFhelix_z0;   //!
   TBranch        *b_RFhelix_r;   //!
   TBranch        *b_RFhelix_dz;   //!
   TBranch        *b_RFtargetdist;   //!
   TBranch        *b_RFtargetdist_x;   //!
   TBranch        *b_RFtargetdist_y;   //!
   TBranch        *b_RFtargetdist_z;   //!
   TBranch        *b_RFtargetdist_t;   //!
   TBranch        *b_RFfirst_layer;   //!
   TBranch        *b_RFfirst_y;   //!
   TBranch        *b_RFlast_layer;   //!
   TBranch        *b_RFlast_y;   //!
   TBranch        *b_RFdE;   //!
   TBranch        *b_RFdEdx;   //!
   TBranch        *b_RFmom0;   //!
   TBranch        *b_RFpath;   //!
   TBranch        *b_RFisElectron;   //!
   TBranch        *b_RFnsigma_triton;   //!
   TBranch        *b_RFnsigma_deutron;   //!
   TBranch        *b_RFnsigma_proton;   //!
   TBranch        *b_RFnsigma_kaon;   //!
   TBranch        *b_RFnsigma_pion;   //!
   TBranch        *b_RFnsigma_electron;   //!
   TBranch        *b_RFhitlayer;   //!
   TBranch        *b_RFhitpos_x;   //!
   TBranch        *b_RFhitpos_y;   //!
   TBranch        *b_RFhitpos_z;   //!
   TBranch        *b_RFcalpos_x;   //!
   TBranch        *b_RFcalpos_y;   //!
   TBranch        *b_RFcalpos_z;   //!
   TBranch        *b_RFmom_x;   //!
   TBranch        *b_RFmom_y;   //!
   TBranch        *b_RFmom_z;   //!
   TBranch        *b_RFresidual;   //!
   TBranch        *b_RFresidual_x;   //!
   TBranch        *b_RFresidual_y;   //!
   TBranch        *b_RFresidual_z;   //!
   TBranch        *b_RFresolution_x;   //!
   TBranch        *b_RFresolution_y;   //!
   TBranch        *b_RFresolution_z;   //!
   TBranch        *b_RFhelix_t;   //!
   TBranch        *b_RFpathhit;   //!
   TBranch        *b_RFalpha;   //!
   TBranch        *b_RFtrack_cluster_de;   //!
   TBranch        *b_RFtrack_cluster_mrow;   //!
   TBranch        *b_RFchargeIndistinguishable;   //!
   TBranch        *b_RFchisqr_inverted;   //!
   TBranch        *b_RFpval_inverted;   //!
   TBranch        *b_RFcharge_inverted;   //!
   TBranch        *b_RFhelix_cx_inverted;   //!
   TBranch        *b_RFhelix_cy_inverted;   //!
   TBranch        *b_RFhelix_z0_inverted;   //!
   TBranch        *b_RFhelix_r_inverted;   //!
   TBranch        *b_RFhelix_dz_inverted;   //!
   TBranch        *b_RFmom0_inverted;   //!
   TBranch        *b_RFpid_inverted;   //!
   TBranch        *b_RFGFfitstatus;   //!
   TBranch        *b_RFGFpdgcode;   //!
   TBranch        *b_RFGFnhtrack;   //!
   TBranch        *b_RFGFcharge;   //!
   TBranch        *b_RFGFchisqr;   //!
   TBranch        *b_RFGFtof;   //!
   TBranch        *b_RFGFpval;   //!
   TBranch        *b_RFGFlayer;   //!
   TBranch        *b_RFGFpos_x;   //!
   ...
   TBranch        *b_RFGFmom_y;   //!
   TBranch        *b_RFGFmom_z;   //!
   TBranch        *b_RFGFresidual_x;   //!
   TBranch        *b_RFGFresidual_y;   //!
   TBranch        *b_RFGFresidual_z;   //!
   TBranch        *b_RFGFresidual_p;   //!
   TBranch        *b_RFGFresidual_px;   //!
   TBranch        *b_RFGFresidual_py;   //!
   TBranch        *b_RFGFresidual_pz;   //!
   TBranch        *b_RFGFinside;   //!
   TBranch        *b_RFGFntTpc_inside;   //!
   TBranch        *b_RFGFprodvtx_x;   //!
   TBranch        *b_RFGFprodvtx_y;   //!
   TBranch        *b_RFGFprodvtx_z;   //!
   TBranch        *b_RFGFtracklen;   //!
   TBranch        *b_RFGFtrack2vtxdist;   //!
   TBranch        *b_RFGFcalctof;   //!
   TBranch        *b_RFGFsegHtof;   //!
   TBranch        *b_RFGFtofHtof;   //!
   TBranch        *b_RFGFtdiffHtof;   //!
   TBranch        *b_RFGFposHtof;   //!
   TBranch        *b_RFGFposx;   //!
   TBranch        *b_RFGFposy;   //!
   TBranch        *b_RFGFposz;   //!
   TBranch        *b_RFGFinvbeta;   //!
   TBranch        *b_RFGFm2;   //!
   TBranch        *b_RFnsigma_tritonHtof;   //!
   TBranch        *b_RFnsigma_deutronHtof;   //!
   TBranch        *b_RFnsigma_protonHtof;   //!
   TBranch        *b_RFnsigma_kaonHtof;   //!
   TBranch        *b_RFnsigma_pionHtof;   //!
   TBranch        *b_RFnsigma_electronHtof;   //!
   TBranch        *b_RFXiflag;   //!
   TBranch        *b_RFXiRefitflag;   //!
   TBranch        *b_RFXiPflag;   //!
   TBranch        *b_RFXiMass;   //!
   TBranch        *b_RFXiDecayVtx_x;   //!
   TBranch        *b_RFXiDecayVtx_y;   //!
   TBranch        *b_RFXiDecayVtx_z;   //!
   TBranch        *b_RFXiMom;   //!
   TBranch        *b_RFXiMom_x;   //!
   TBranch        *b_RFXiMom_y;   //!
   TBranch        *b_RFXiMom_z;   //!
   TBranch        *b_RFXiVtxCloseDist;   //!
   TBranch        *b_RFLambdaMass;   //!
   TBranch        *b_RFLambdaDecayVtx_x;   //!
   TBranch        *b_RFLambdaDecayVtx_y;   //!
   TBranch        *b_RFLambdaDecayVtx_z;   //!
   TBranch        *b_RFLambdaMom;   //!
   TBranch        *b_RFLambdaMom_x;   //!
   TBranch        *b_RFLambdaMom_y;   //!
   TBranch        *b_RFLambdaMom_z;   //!
   TBranch        *b_RFLambdaVtxCloseDist;   //!
   TBranch        *b_RFXiTargetVtx_x;   //!
   TBranch        *b_RFXiTargetVtx_y;   //!
   TBranch        *b_RFXiTargetVtx_z;   //!
   TBranch        *b_RFXiTargetMom;   //!
   TBranch        *b_RFXiTargetMom_x;   //!
   TBranch        *b_RFXiTargetMom_y;   //!
   TBranch        *b_RFXiTargetMom_z;   //!
   TBranch        *b_RFXiTargetCloseDist_dist;   //!
   TBranch        *b_RFLflag;   //!
   TBranch        *b_RFLambdaTargetCloseDist_dist;   //!
   TBranch        *b_RFLambdaTargetCloseVtx_x;   //!
   TBranch        *b_RFLambdaTargetCloseVtx_y;   //!
   TBranch        *b_RFLambdaTargetCloseVtx_z;   //!
   TBranch        *b_RFGFXiMass;   //!
   TBranch        *b_RFGFXiDecayVtx_x;   //!
   TBranch        *b_RFGFXiDecayVtx_y;   //!
   TBranch        *b_RFGFXiDecayVtx_z;   //!
   TBranch        *b_RFGFXiMom;   //!
   TBranch        *b_RFGFXiMom_x;   //!
   TBranch        *b_RFGFXiMom_y;   //!
   TBranch        *b_RFGFXiMom_z;   //!
   TBranch        *b_RFGFXiVtxCloseDist;   //!
   TBranch        *b_RFGFXiKKVtx_x;   //!
   TBranch        *b_RFGFXiKKVtx_y;   //!
   TBranch        *b_RFGFXiKKVtx_z;   //!
   TBranch        *b_RFGFXiKKVtxMom;   //!
   TBranch        *b_RFGFXiKKVtxMom_x;   //!
   TBranch        *b_RFGFXiKKVtxMom_y;   //!
   TBranch        *b_RFGFXiKKVtxMom_z;   //!
   TBranch        *b_RFGFXiKKVtxCloseDist;   //!
   TBranch        *b_RFGFXiProductionVtx_x;   //!
   TBranch        *b_RFGFXiProductionVtx_y;   //!
   TBranch        *b_RFGFXiProductionVtx_z;   //!
   TBranch        *b_RFGFXiProductionVtxMom;   //!
   TBranch        *b_RFGFXiProductionVtxMom_x;   //!
   TBranch        *b_RFGFXiProductionVtxMom_y;   //!
   TBranch        *b_RFGFXiProductionVtxMom_z;   //!
   TBranch        *b_RFGFXiProductionVtxCloseDist;   //!
   TBranch        *b_RFGFXiTrackLen;   //!
   TBranch        *b_RFGFXiTof;   //!
   TBranch        *b_RFGFXiMomLoss;   //!
   TBranch        *b_RFGFXiExcitation;   //!
   TBranch        *b_RFGFXiTarget_x;   //!
   TBranch        *b_RFGFXiTarget_y;   //!
   TBranch        *b_RFGFXiTarget_z;   //!
   TBranch        *b_RFGFXiTargetMom;   //!
   TBranch        *b_RFGFXiTargetMom_x;   //!
   TBranch        *b_RFGFXiTargetMom_y;   //!
   TBranch        *b_RFGFXiTargetMom_z;   //!
   TBranch        *b_RFGFXiTargetCloseDist;   //!
   TBranch        *b_RFGFXiTargetCenter_x;   //!
   TBranch        *b_RFGFXiTargetCenter_y;   //!
   TBranch        *b_RFGFXiTargetCenter_z;   //!
   TBranch        *b_RFGFXiTargetCenterMom;   //!
   TBranch        *b_RFGFXiTargetCenterMom_x;   //!
   TBranch        *b_RFGFXiTargetCenterMom_y;   //!
   TBranch        *b_RFGFXiTargetCenterMom_z;   //!
   TBranch        *b_RFGFXiTargetCenterCloseDist;   //!
   TBranch        *b_RFGFLambdaMass;   //!
   TBranch        *b_RFGFLambdaDecayVtx_x;   //!
   TBranch        *b_RFGFLambdaDecayVtx_y;   //!
   TBranch        *b_RFGFLambdaDecayVtx_z;   //!
   TBranch        *b_RFGFLambdaMom;   //!
   TBranch        *b_RFGFLambdaMom_x;   //!
   TBranch        *b_RFGFLambdaMom_y;   //!
   TBranch        *b_RFGFLambdaMom_z;   //!
   TBranch        *b_RFGFLambdaVtxCloseDist;   //!
   TBranch        *b_RFGFLambdaTargetCloseDist;   //!
   TBranch        *b_RFGFLambdaTarget_x;   //!
   TBranch        *b_RFGFLambdaTarget_y;   //!
   TBranch        *b_RFGFLambdaTarget_z;   //!
   TBranch        *b_RFGFLambdaTargetCenter_x;   //!
   TBranch        *b_RFGFLambdaTargetCenter_y;   //!
   TBranch        *b_RFGFLambdaTargetCenter_z;   //!
   TBranch        *b_RFGFLambdaTargetCenterCloseDist;   //!
   TBranch        *b_RFGFLambdaProductionVtx_x;   //!
   TBranch        *b_RFGFLambdaProductionVtx_y;   //!
   TBranch        *b_RFGFLambdaProductionVtx_z;   //!
   TBranch        *b_RFGFLambdaProductionVtxCloseDist;   //!
   TBranch        *b_RFGFLambdaTrackLen;   //!
   TBranch        *b_RFGFLambdaTof;   //!
   TBranch        *b_RFXiDecaysTrackId;   //!
   TBranch        *b_RFXiDecaysPurity;   //!
   TBranch        *b_RFXiDecaysEfficiency;   //!
   TBranch        *b_RFXiDecaysG4tid;   //!
   TBranch        *b_RFXiDecaysMom;   //!
   TBranch        *b_RFXiDecaysMom_x;   //!
   TBranch        *b_RFXiDecaysMom_y;   //!
   TBranch        *b_RFXiDecaysMom_z;   //!
   TBranch        *b_RFXiRefitDist_p_xz;   //!
   TBranch        *b_RFXiRefitDist_p_y;   //!
   TBranch        *b_RFXiRefitDist_pi1_xz;   //!
   TBranch        *b_RFXiRefitDist_pi1_y;   //!
   TBranch        *b_RFXiRefitDist_pi2_xz;   //!
   TBranch        *b_RFXiRefitDist_pi2_y;   //!
   TBranch        *b_RFXiRefitDist_xi_xz;   //!
   TBranch        *b_RFXiRefitDist_xi_y;   //!
   TBranch        *b_RFGFXiDecaysNhit;   //!
   TBranch        *b_RFGFXiDecaysChisqr;   //!
   TBranch        *b_RFGFXiDecaysCharge;   //!
   TBranch        *b_RFGFXiDecaysTof;   //!
   TBranch        *b_RFGFXiDecaysPval;   //!
   TBranch        *b_RFGFXiDecaysPdgcode;   //!
   TBranch        *b_RFGFXiDecaysHtofId;   //!
   TBranch        *b_RFGFXiDecaysTrackLen;   //!
   TBranch        *b_RFGFXiDecaysTrackTof;   //!
   TBranch        *b_RFGFXiDecaysMassSquare;   //!
   TBranch        *b_RFGFXiDecaysInvbeta;   //!
   TBranch        *b_RFGFXiDecaysMom;   //!
   TBranch        *b_RFGFXiDecaysMom_x;   //!
   TBranch        *b_RFGFXiDecaysMom_y;   //!
   TBranch        *b_RFGFXiDecaysMom_z;   //!
   TBranch        *b_RFGFXiDecaysMomCM;   //!
   TBranch        *b_RFGFXiDecaysMomCM_x;   //!
   TBranch        *b_RFGFXiDecaysMomCM_y;   //!
   TBranch        *b_RFGFXiDecaysMomCM_z;   //!
   TBranch        *b_RFGFXiDecaysMomLoss;   //!
   TBranch        *b_RFGFXiDecaysELoss;   //!
   TBranch        *b_RFAccidentalMultiplicity;   //!
   TBranch        *b_RFAccidentalTrackId;   //!
   TBranch        *b_RFXiResidualsMultiplicity;   //!
   TBranch        *b_RFXipMultiplicity;   //!
   TBranch        *b_RFXipipMultiplicity;   //!
   TBranch        *b_RFXipimMultiplicity;   //!
   TBranch        *b_RFXiepMultiplicity;   //!
   TBranch        *b_RFXiemMultiplicity;   //!
   TBranch        *b_RFXippipMultiplicity;   //!
   TBranch        *b_RFXiResidualsTrackId;   //!
   TBranch        *b_RFXiResidualsMassSquare;   //!
   TBranch        *b_RFXiResidualsInvbeta;   //!
   TBranch        *b_RFXiResidualsCloseDistTgt;   //!
   TBranch        *b_RFXiResidualsGFProductionVtxCloseDist;   //!
   TBranch        *b_RFXiResidualsGFProductionVtx_x;   //!
   TBranch        *b_RFXiResidualsGFProductionVtx_y;   //!
   TBranch        *b_RFXiResidualsGFProductionVtx_z;   //!
   TBranch        *b_RFXiResidualsGFProductionMom;   //!
   TBranch        *b_RFXiResidualsGFProductionMom_x;   //!
   TBranch        *b_RFXiResidualsGFProductionMom_y;   //!
   TBranch        *b_RFXiResidualsGFProductionMom_z;   //!
   TBranch        *b_RFXiResidualsKFProductionVtxCloseDist;   //!
   TBranch        *b_RFXiResidualsKFProductionVtx_x;   //!
   TBranch        *b_RFXiResidualsKFProductionVtx_y;   //!
   TBranch        *b_RFXiResidualsKFProductionVtx_z;   //!
   TBranch        *b_RFXiResidualsKFProductionMom;   //!
   TBranch        *b_RFXiResidualsKFProductionMom_x;   //!
   TBranch        *b_RFXiResidualsKFProductionMom_y;   //!
   TBranch        *b_RFXiResidualsKFProductionMom_z;   //!
   TBranch        *b_RFXiResidualsMom;   //!
   TBranch        *b_RFXiResidualsMom_x;   //!
   TBranch        *b_RFXiResidualsMom_y;   //!
   TBranch        *b_RFXiResidualsMom_z;   //!
   TBranch        *b_RFXiResidualsCharge;   //!
   TBranch        *b_RFKFLambdaMom;   //!
   TBranch        *b_RFKFLambdaMom_x;   //!
   TBranch        *b_RFKFLambdaMom_y;   //!
   TBranch        *b_RFKFLambdaMom_z;   //!
   TBranch        *b_RFKFLambdaChisqr;   //!
   TBranch        *b_RFKFLambdaPval;   //!
   TBranch        *b_RFKFLambdaPull;   //!
   TBranch        *b_RFKFLambdaCovMatrix;   //!
   TBranch        *b_RFKFXiVtxCloseDist;   //!
   TBranch        *b_RFKFXiMom;   //!
   TBranch        *b_RFKFXiMom_x;   //!
   TBranch        *b_RFKFXiMom_y;   //!
   TBranch        *b_RFKFXiMom_z;   //!
   TBranch        *b_RFKFXiChisqr;   //!
   TBranch        *b_RFKFXiPval;   //!
   TBranch        *b_RFKFXiMass;   //!
   TBranch        *b_RFKFXiDecayVtx_x;   //!
   TBranch        *b_RFKFXiDecayVtx_y;   //!
   TBranch        *b_RFKFXiDecayVtx_z;   //!
   TBranch        *b_RFKFXiPull;   //!
   TBranch        *b_RFKFXiCovMatrix;   //!
   TBranch        *b_RFKFKKXiProductionVtxChisqr;   //!
   TBranch        *b_RFKFKKXiProductionVtx_x;   //!
   TBranch        *b_RFKFKKXiProductionVtx_y;   //!
   TBranch        *b_RFKFKKXiProductionVtx_z;   //!
   TBranch        *b_RFKFXiProductionVtx_x;   //!
   TBranch        *b_RFKFXiProductionVtx_y;   //!
   TBranch        *b_RFKFXiProductionVtx_z;   //!
   TBranch        *b_RFKFXiProductionVtxMom;   //!
   TBranch        *b_RFKFXiProductionVtxMom_x;   //!
   TBranch        *b_RFKFXiProductionVtxMom_y;   //!
   TBranch        *b_RFKFXiProductionVtxMom_z;   //!
   TBranch        *b_RFKFXiProductionVtxCloseDist;   //!
   TBranch        *b_RFKFXiTrackLen;   //!
   TBranch        *b_RFKFXiTof;   //!
   TBranch        *b_RFKFXiMomLoss;   //!
   TBranch        *b_RFKFXiExcitation;   //!
   TBranch        *b_RFKFKpXiProductionVtx_x;   //!
   TBranch        *b_RFKFKpXiProductionVtx_y;   //!
   TBranch        *b_RFKFKpXiProductionVtx_z;   //!
   TBranch        *b_RFKFXiProductionVtx_x_KpXi;   //!
   TBranch        *b_RFKFXiProductionVtx_y_KpXi;   //!
   TBranch        *b_RFKFXiProductionVtx_z_KpXi;   //!
   TBranch        *b_RFKFXiProductionVtxMom_KpXi;   //!
   TBranch        *b_RFKFXiProductionVtxMom_x_KpXi;   //!
   TBranch        *b_RFKFXiProductionVtxMom_y_KpXi;   //!
   TBranch        *b_RFKFXiProductionVtxMom_z_KpXi;   //!
   TBranch        *b_RFKFXiProductionVtxCloseDist_KpXi;   //!
   TBranch        *b_RFKFXiProductionVtx_x_KK;   //!
   TBranch        *b_RFKFXiProductionVtx_y_KK;   //!
   TBranch        *b_RFKFXiProductionVtx_z_KK;   //!
   TBranch        *b_RFKFXiProductionVtxMom_KK;   //!
   TBranch        *b_RFKFXiProductionVtxMom_x_KK;   //!
   TBranch        *b_RFKFXiProductionVtxMom_y_KK;   //!
   TBranch        *b_RFKFXiProductionVtxMom_z_KK;   //!
   TBranch        *b_RFKFXiProductionVtxCloseDist_KK;   //!
   TBranch        *b_RFKFXiDecaysMom;   //!
   TBranch        *b_RFKFXiDecaysMom_x;   //!
   TBranch        *b_RFKFXiDecaysMom_y;   //!
   TBranch        *b_RFKFXiDecaysMom_z;   //!

   g4refitcarbon(TTree *tree=0);
   virtual ~g4refitcarbon();
...
g4refitcarbon::g4refitcarbon(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/had/kangbm/ws/k18-analyzer/rootfiles/Geant4Prod/WeightedFermi/XiPMissProd_P_0_0_GenfitCarbonRefitXiGeant4.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/had/kangbm/ws/k18-analyzer/rootfiles/Geant4Prod/WeightedFermi/XiPMissProd_P_0_0_GenfitCarbonRefitXiGeant4.root");
      }
...
g4refitcarbon::~g4refitcarbon()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t g4refitcarbon::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t g4refitcarbon::LoadTree(Long64_t entry)
{
...
void g4refitcarbon::Init(TTree *tree)
{
   ...
   isXiDaughter = 0;
   isXiResidual = 0;
   RFremain_cluster_x = 0;
   RFremain_cluster_y = 0;
   RFremain_cluster_z = 0;
   RFremain_cluster_de = 0;
   RFremain_cluster_size = 0;
   RFremain_cluster_layer = 0;
   RFremain_cluster_mrow = 0;
   RFremain_cluster_row_center = 0;
   RFremain_cluster_houghflag = 0;
   RFXi_cluster_x = 0;
   RFXi_cluster_y = 0;
   RFXi_cluster_z = 0;
   RFXi_cluster_de = 0;
   RFXi_cluster_size = 0;
   RFXi_cluster_layer = 0;
   RFXi_cluster_mrow = 0;
   RFXi_cluster_row_center = 0;
   trackmap_RF_to_Helix = 0;
   trackmap_Helix_to_RF = 0;
   RFnhtrack = 0;
   RFtrackid = 0;
   RFisXi = 0;
   RFisBeam = 0;
   ...
   RFpathhit = 0;
   RFalpha = 0;
   RFtrack_cluster_de = 0;
   RFtrack_cluster_mrow = 0;
   RFchargeIndistinguishable = 0;
   RFchisqr_inverted = 0;
   RFpval_inverted = 0;
   RFcharge_inverted = 0;
   RFhelix_cx_inverted = 0;
   RFhelix_cy_inverted = 0;
   RFhelix_z0_inverted = 0;
   RFhelix_r_inverted = 0;
   RFhelix_dz_inverted = 0;
   RFmom0_inverted = 0;
   RFpid_inverted = 0;
   RFGFfitstatus = 0;
   RFGFpdgcode = 0;
   ...
   RFGFinvbeta = 0;
   RFGFm2 = 0;
   RFnsigma_tritonHtof = 0;
   RFnsigma_deutronHtof = 0;
   RFnsigma_protonHtof = 0;
   RFnsigma_kaonHtof = 0;
   RFnsigma_pionHtof = 0;
   RFnsigma_electronHtof = 0;
   RFXiDecaysTrackId = 0;
   RFXiDecaysPurity = 0;
   RFXiDecaysEfficiency = 0;
   RFXiDecaysG4tid = 0;
   RFXiDecaysMom = 0;
   RFXiDecaysMom_x = 0;
   RFXiDecaysMom_y = 0;
   RFXiDecaysMom_z = 0;
   RFXiRefitDist_p_xz = 0;
   RFXiRefitDist_p_y = 0;
   RFXiRefitDist_pi1_xz = 0;
   RFXiRefitDist_pi1_y = 0;
   RFXiRefitDist_pi2_xz = 0;
   RFXiRefitDist_pi2_y = 0;
   RFXiRefitDist_xi_xz = 0;
   RFXiRefitDist_xi_y = 0;
   RFGFXiDecaysNhit = 0;
   RFGFXiDecaysChisqr = 0;
   RFGFXiDecaysCharge = 0;
   RFGFXiDecaysTof = 0;
   RFGFXiDecaysPval = 0;
   RFGFXiDecaysPdgcode = 0;
   RFGFXiDecaysHtofId = 0;
   RFGFXiDecaysTrackLen = 0;
   RFGFXiDecaysTrackTof = 0;
   RFGFXiDecaysMassSquare = 0;
   RFGFXiDecaysInvbeta = 0;
   RFGFXiDecaysMom = 0;
   RFGFXiDecaysMom_x = 0;
   RFGFXiDecaysMom_y = 0;
   RFGFXiDecaysMom_z = 0;
   RFGFXiDecaysMomCM = 0;
   RFGFXiDecaysMomCM_x = 0;
   RFGFXiDecaysMomCM_y = 0;
   RFGFXiDecaysMomCM_z = 0;
   RFGFXiDecaysMomLoss = 0;
   RFGFXiDecaysELoss = 0;
   RFAccidentalTrackId = 0;
   RFXiResidualsTrackId = 0;
   RFXiResidualsMassSquare = 0;
   RFXiResidualsInvbeta = 0;
   RFXiResidualsCloseDistTgt = 0;
   RFXiResidualsGFProductionVtxCloseDist = 0;
   RFXiResidualsGFProductionVtx_x = 0;
   RFXiResidualsGFProductionVtx_y = 0;
   RFXiResidualsGFProductionVtx_z = 0;
   RFXiResidualsGFProductionMom = 0;
   RFXiResidualsGFProductionMom_x = 0;
   RFXiResidualsGFProductionMom_y = 0;
   RFXiResidualsGFProductionMom_z = 0;
   RFXiResidualsKFProductionVtxCloseDist = 0;
   RFXiResidualsKFProductionVtx_x = 0;
   RFXiResidualsKFProductionVtx_y = 0;
   RFXiResidualsKFProductionVtx_z = 0;
   RFXiResidualsKFProductionMom = 0;
   RFXiResidualsKFProductionMom_x = 0;
   RFXiResidualsKFProductionMom_y = 0;
   RFXiResidualsKFProductionMom_z = 0;
   RFXiResidualsMom = 0;
   RFXiResidualsMom_x = 0;
   RFXiResidualsMom_y = 0;
   RFXiResidualsMom_z = 0;
   RFXiResidualsCharge = 0;
   RFKFLambdaPull = 0;
   RFKFLambdaCovMatrix = 0;
   RFKFXiPull = 0;
   RFKFXiCovMatrix = 0;
   RFKFXiDecaysMom = 0;
   RFKFXiDecaysMom_x = 0;
   ...
   fChain->SetBranchAddress("nhittpc", &nhittpc, &b_nhittpc);
   fChain->SetBranchAddress("ititpc", &ititpc, &b_ititpc);
   fChain->SetBranchAddress("idtpc", &idtpc, &b_idtpc);
   fChain->SetBranchAddress("x0tpc", &x0tpc, &b_x0tpc);
   fChain->SetBranchAddress("y0tpc", &y0tpc, &b_y0tpc);
   fChain->SetBranchAddress("z0tpc", &z0tpc, &b_z0tpc);
   fChain->SetBranchAddress("xtpc", &xtpc, &b_xtpc);
   fChain->SetBranchAddress("ytpc", &ytpc, &b_ytpc);
   fChain->SetBranchAddress("ztpc", &ztpc, &b_ztpc);
   fChain->SetBranchAddress("pxtpc", &pxtpc, &b_pxtpc);
   fChain->SetBranchAddress("pytpc", &pytpc, &b_pytpc);
   fChain->SetBranchAddress("pztpc", &pztpc, &b_pztpc);
   ...
   fChain->SetBranchAddress("isXiDaughter", &isXiDaughter, &b_isXiDaughter);
   fChain->SetBranchAddress("isXiResidual", &isXiResidual, &b_isXiResidual);
   fChain->SetBranchAddress("RFremain_nclTpc", &RFremain_nclTpc, &b_RFremain_nclTpc);
   fChain->SetBranchAddress("RFremain_cluster_x", &RFremain_cluster_x, &b_RFremain_cluster_x);
   fChain->SetBranchAddress("RFremain_cluster_y", &RFremain_cluster_y, &b_RFremain_cluster_y);
   fChain->SetBranchAddress("RFremain_cluster_z", &RFremain_cluster_z, &b_RFremain_cluster_z);
   fChain->SetBranchAddress("RFremain_cluster_de", &RFremain_cluster_de, &b_RFremain_cluster_de);
   fChain->SetBranchAddress("RFremain_cluster_size", &RFremain_cluster_size, &b_RFremain_cluster_size);
   fChain->SetBranchAddress("RFremain_cluster_layer", &RFremain_cluster_layer, &b_RFremain_cluster_layer);
   fChain->SetBranchAddress("RFremain_cluster_mrow", &RFremain_cluster_mrow, &b_RFremain_cluster_mrow);
   fChain->SetBranchAddress("RFremain_cluster_row_center", &RFremain_cluster_row_center, &b_RFremain_cluster_row_center);
   fChain->SetBranchAddress("RFremain_cluster_houghflag", &RFremain_cluster_houghflag, &b_RFremain_cluster_houghflag);
   fChain->SetBranchAddress("RFXi_nclTpc", &RFXi_nclTpc, &b_RFXi_nclTpc);
   fChain->SetBranchAddress("RFXi_cluster_x", &RFXi_cluster_x, &b_RFXi_cluster_x);
   fChain->SetBranchAddress("RFXi_cluster_y", &RFXi_cluster_y, &b_RFXi_cluster_y);
   fChain->SetBranchAddress("RFXi_cluster_z", &RFXi_cluster_z, &b_RFXi_cluster_z);
   fChain->SetBranchAddress("RFXi_cluster_de", &RFXi_cluster_de, &b_RFXi_cluster_de);
   fChain->SetBranchAddress("RFXi_cluster_size", &RFXi_cluster_size, &b_RFXi_cluster_size);
   fChain->SetBranchAddress("RFXi_cluster_layer", &RFXi_cluster_layer, &b_RFXi_cluster_layer);
   fChain->SetBranchAddress("RFXi_cluster_mrow", &RFXi_cluster_mrow, &b_RFXi_cluster_mrow);
   fChain->SetBranchAddress("RFXi_cluster_row_center", &RFXi_cluster_row_center, &b_RFXi_cluster_row_center);
   fChain->SetBranchAddress("RFntTpc", &RFntTpc, &b_RFntTpc);
   fChain->SetBranchAddress("trackmap_RF_to_Helix", &trackmap_RF_to_Helix, &b_trackmap_RF_to_Helix);
   fChain->SetBranchAddress("trackmap_Helix_to_RF", &trackmap_Helix_to_RF, &b_trackmap_Helix_to_RF);
   fChain->SetBranchAddress("RFnhtrack", &RFnhtrack, &b_RFnhtrack);
   fChain->SetBranchAddress("RFtrackid", &RFtrackid, &b_RFtrackid);
   fChain->SetBranchAddress("RFisXi", &RFisXi, &b_RFisXi);
   fChain->SetBranchAddress("RFisBeam", &RFisBeam, &b_RFisBeam);
   fChain->SetBranchAddress("RFisKurama", &RFisKurama, &b_RFisKurama);
   fChain->SetBranchAddress("RFisK18", &RFisK18, &b_RFisK18);
   fChain->SetBranchAddress("RFisXiDaughter", &RFisXiDaughter, &b_RFisXiDaughter);
   fChain->SetBranchAddress("RFisXiResidual", &RFisXiResidual, &b_RFisXiResidual);
   fChain->SetBranchAddress("RFisAccidental", &RFisAccidental, &b_RFisAccidental);
   fChain->SetBranchAddress("RFisMultiloop", &RFisMultiloop, &b_RFisMultiloop);
   fChain->SetBranchAddress("RFisInTarget", &RFisInTarget, &b_RFisInTarget);
   fChain->SetBranchAddress("RFhasNoFlag", &RFhasNoFlag, &b_RFhasNoFlag);
   fChain->SetBranchAddress("RFcharge", &RFcharge, &b_RFcharge);
   fChain->SetBranchAddress("RFpid", &RFpid, &b_RFpid);
   fChain->SetBranchAddress("RFchisqr", &RFchisqr, &b_RFchisqr);
   fChain->SetBranchAddress("RFpval", &RFpval, &b_RFpval);
   fChain->SetBranchAddress("RFpurity", &RFpurity, &b_RFpurity);
   fChain->SetBranchAddress("RFefficiency", &RFefficiency, &b_RFefficiency);
   fChain->SetBranchAddress("RFG4tid", &RFG4tid, &b_RFG4tid);
   fChain->SetBranchAddress("RFG4pid", &RFG4pid, &b_RFG4pid);
   fChain->SetBranchAddress("RFhelix_cx", &RFhelix_cx, &b_RFhelix_cx);
   fChain->SetBranchAddress("RFhelix_cy", &RFhelix_cy, &b_RFhelix_cy);
   fChain->SetBranchAddress("RFhelix_z0", &RFhelix_z0, &b_RFhelix_z0);
   fChain->SetBranchAddress("RFhelix_r", &RFhelix_r, &b_RFhelix_r);
   fChain->SetBranchAddress("RFhelix_dz", &RFhelix_dz, &b_RFhelix_dz);
   fChain->SetBranchAddress("RFtargetdist", &RFtargetdist, &b_RFtargetdist);
   fChain->SetBranchAddress("RFtargetdist_x", &RFtargetdist_x, &b_RFtargetdist_x);
   fChain->SetBranchAddress("RFtargetdist_y", &RFtargetdist_y, &b_RFtargetdist_y);
   fChain->SetBranchAddress("RFtargetdist_z", &RFtargetdist_z, &b_RFtargetdist_z);
   fChain->SetBranchAddress("RFtargetdist_t", &RFtargetdist_t, &b_RFtargetdist_t);
   fChain->SetBranchAddress("RFfirst_layer", &RFfirst_layer, &b_RFfirst_layer);
   fChain->SetBranchAddress("RFfirst_y", &RFfirst_y, &b_RFfirst_y);
   fChain->SetBranchAddress("RFlast_layer", &RFlast_layer, &b_RFlast_layer);
   fChain->SetBranchAddress("RFlast_y", &RFlast_y, &b_RFlast_y);
   fChain->SetBranchAddress("RFdE", &RFdE, &b_RFdE);
   fChain->SetBranchAddress("RFdEdx", &RFdEdx, &b_RFdEdx);
   fChain->SetBranchAddress("RFmom0", &RFmom0, &b_RFmom0);
   fChain->SetBranchAddress("RFpath", &RFpath, &b_RFpath);
   fChain->SetBranchAddress("RFisElectron", &RFisElectron, &b_RFisElectron);
   fChain->SetBranchAddress("RFnsigma_triton", &RFnsigma_triton, &b_RFnsigma_triton);
   fChain->SetBranchAddress("RFnsigma_deutron", &RFnsigma_deutron, &b_RFnsigma_deutron);
   fChain->SetBranchAddress("RFnsigma_proton", &RFnsigma_proton, &b_RFnsigma_proton);
   fChain->SetBranchAddress("RFnsigma_kaon", &RFnsigma_kaon, &b_RFnsigma_kaon);
   fChain->SetBranchAddress("RFnsigma_pion", &RFnsigma_pion, &b_RFnsigma_pion);
   fChain->SetBranchAddress("RFnsigma_electron", &RFnsigma_electron, &b_RFnsigma_electron);
   fChain->SetBranchAddress("RFhitlayer", &RFhitlayer, &b_RFhitlayer);
   fChain->SetBranchAddress("RFhitpos_x", &RFhitpos_x, &b_RFhitpos_x);
   fChain->SetBranchAddress("RFhitpos_y", &RFhitpos_y, &b_RFhitpos_y);
   fChain->SetBranchAddress("RFhitpos_z", &RFhitpos_z, &b_RFhitpos_z);
   fChain->SetBranchAddress("RFcalpos_x", &RFcalpos_x, &b_RFcalpos_x);
   fChain->SetBranchAddress("RFcalpos_y", &RFcalpos_y, &b_RFcalpos_y);
   fChain->SetBranchAddress("RFcalpos_z", &RFcalpos_z, &b_RFcalpos_z);
   fChain->SetBranchAddress("RFmom_x", &RFmom_x, &b_RFmom_x);
   fChain->SetBranchAddress("RFmom_y", &RFmom_y, &b_RFmom_y);
   fChain->SetBranchAddress("RFmom_z", &RFmom_z, &b_RFmom_z);
   fChain->SetBranchAddress("RFresidual", &RFresidual, &b_RFresidual);
   fChain->SetBranchAddress("RFresidual_x", &RFresidual_x, &b_RFresidual_x);
   fChain->SetBranchAddress("RFresidual_y", &RFresidual_y, &b_RFresidual_y);
   fChain->SetBranchAddress("RFresidual_z", &RFresidual_z, &b_RFresidual_z);
   fChain->SetBranchAddress("RFresolution_x", &RFresolution_x, &b_RFresolution_x);
   fChain->SetBranchAddress("RFresolution_y", &RFresolution_y, &b_RFresolution_y);
   fChain->SetBranchAddress("RFresolution_z", &RFresolution_z, &b_RFresolution_z);
   fChain->SetBranchAddress("RFhelix_t", &RFhelix_t, &b_RFhelix_t);
   fChain->SetBranchAddress("RFpathhit", &RFpathhit, &b_RFpathhit);
   fChain->SetBranchAddress("RFalpha", &RFalpha, &b_RFalpha);
   fChain->SetBranchAddress("RFtrack_cluster_de", &RFtrack_cluster_de, &b_RFtrack_cluster_de);
   fChain->SetBranchAddress("RFtrack_cluster_mrow", &RFtrack_cluster_mrow, &b_RFtrack_cluster_mrow);
   fChain->SetBranchAddress("RFchargeIndistinguishable", &RFchargeIndistinguishable, &b_RFchargeIndistinguishable);
   fChain->SetBranchAddress("RFchisqr_inverted", &RFchisqr_inverted, &b_RFchisqr_inverted);
   fChain->SetBranchAddress("RFpval_inverted", &RFpval_inverted, &b_RFpval_inverted);
   fChain->SetBranchAddress("RFcharge_inverted", &RFcharge_inverted, &b_RFcharge_inverted);
   fChain->SetBranchAddress("RFhelix_cx_inverted", &RFhelix_cx_inverted, &b_RFhelix_cx_inverted);
   fChain->SetBranchAddress("RFhelix_cy_inverted", &RFhelix_cy_inverted, &b_RFhelix_cy_inverted);
   fChain->SetBranchAddress("RFhelix_z0_inverted", &RFhelix_z0_inverted, &b_RFhelix_z0_inverted);
   fChain->SetBranchAddress("RFhelix_r_inverted", &RFhelix_r_inverted, &b_RFhelix_r_inverted);
   fChain->SetBranchAddress("RFhelix_dz_inverted", &RFhelix_dz_inverted, &b_RFhelix_dz_inverted);
   fChain->SetBranchAddress("RFmom0_inverted", &RFmom0_inverted, &b_RFmom0_inverted);
   fChain->SetBranchAddress("RFpid_inverted", &RFpid_inverted, &b_RFpid_inverted);
   fChain->SetBranchAddress("RFGFfitstatus", &RFGFfitstatus, &b_RFGFfitstatus);
   fChain->SetBranchAddress("RFGFpdgcode", &RFGFpdgcode, &b_RFGFpdgcode);
   fChain->SetBranchAddress("RFGFnhtrack", &RFGFnhtrack, &b_RFGFnhtrack);
   fChain->SetBranchAddress("RFGFcharge", &RFGFcharge, &b_RFGFcharge);
   fChain->SetBranchAddress("RFGFchisqr", &RFGFchisqr, &b_RFGFchisqr);
   fChain->SetBranchAddress("RFGFtof", &RFGFtof, &b_RFGFtof);
   fChain->SetBranchAddress("RFGFpval", &RFGFpval, &b_RFGFpval);
   fChain->SetBranchAddress("RFGFlayer", &RFGFlayer, &b_RFGFlayer);
   fChain->SetBranchAddress("RFGFpos_x", &RFGFpos_x, &b_RFGFpos_x);
   fChain->SetBranchAddress("RFGFpos_y", &RFGFpos_y, &b_RFGFpos_y);
   fChain->SetBranchAddress("RFGFpos_z", &RFGFpos_z, &b_RFGFpos_z);
   fChain->SetBranchAddress("RFGFmom", &RFGFmom, &b_RFGFmom);
   fChain->SetBranchAddress("RFGFmom_x", &RFGFmom_x, &b_RFGFmom_x);
   fChain->SetBranchAddress("RFGFmom_y", &RFGFmom_y, &b_RFGFmom_y);
   fChain->SetBranchAddress("RFGFmom_z", &RFGFmom_z, &b_RFGFmom_z);
   fChain->SetBranchAddress("RFGFresidual_x", &RFGFresidual_x, &b_RFGFresidual_x);
   fChain->SetBranchAddress("RFGFresidual_y", &RFGFresidual_y, &b_RFGFresidual_y);
   fChain->SetBranchAddress("RFGFresidual_z", &RFGFresidual_z, &b_RFGFresidual_z);
   fChain->SetBranchAddress("RFGFresidual_p", &RFGFresidual_p, &b_RFGFresidual_p);
   fChain->SetBranchAddress("RFGFresidual_px", &RFGFresidual_px, &b_RFGFresidual_px);
   fChain->SetBranchAddress("RFGFresidual_py", &RFGFresidual_py, &b_RFGFresidual_py);
   fChain->SetBranchAddress("RFGFresidual_pz", &RFGFresidual_pz, &b_RFGFresidual_pz);
   fChain->SetBranchAddress("RFGFinside", &RFGFinside, &b_RFGFinside);
   fChain->SetBranchAddress("RFGFntTpc_inside", &RFGFntTpc_inside, &b_RFGFntTpc_inside);
   fChain->SetBranchAddress("RFGFprodvtx_x", &RFGFprodvtx_x, &b_RFGFprodvtx_x);
   fChain->SetBranchAddress("RFGFprodvtx_y", &RFGFprodvtx_y, &b_RFGFprodvtx_y);
   fChain->SetBranchAddress("RFGFprodvtx_z", &RFGFprodvtx_z, &b_RFGFprodvtx_z);
   fChain->SetBranchAddress("RFGFtracklen", &RFGFtracklen, &b_RFGFtracklen);
   fChain->SetBranchAddress("RFGFtrack2vtxdist", &RFGFtrack2vtxdist, &b_RFGFtrack2vtxdist);
   fChain->SetBranchAddress("RFGFcalctof", &RFGFcalctof, &b_RFGFcalctof);
   fChain->SetBranchAddress("RFGFsegHtof", &RFGFsegHtof, &b_RFGFsegHtof);
   fChain->SetBranchAddress("RFGFtofHtof", &RFGFtofHtof, &b_RFGFtofHtof);
   fChain->SetBranchAddress("RFGFtdiffHtof", &RFGFtdiffHtof, &b_RFGFtdiffHtof);
   fChain->SetBranchAddress("RFGFposHtof", &RFGFposHtof, &b_RFGFposHtof);
   fChain->SetBranchAddress("RFGFposx", &RFGFposx, &b_RFGFposx);
   fChain->SetBranchAddress("RFGFposy", &RFGFposy, &b_RFGFposy);
   fChain->SetBranchAddress("RFGFposz", &RFGFposz, &b_RFGFposz);
   fChain->SetBranchAddress("RFGFinvbeta", &RFGFinvbeta, &b_RFGFinvbeta);
   fChain->SetBranchAddress("RFGFm2", &RFGFm2, &b_RFGFm2);
   fChain->SetBranchAddress("RFnsigma_tritonHtof", &RFnsigma_tritonHtof, &b_RFnsigma_tritonHtof);
   fChain->SetBranchAddress("RFnsigma_deutronHtof", &RFnsigma_deutronHtof, &b_RFnsigma_deutronHtof);
   fChain->SetBranchAddress("RFnsigma_protonHtof", &RFnsigma_protonHtof, &b_RFnsigma_protonHtof);
   fChain->SetBranchAddress("RFnsigma_kaonHtof", &RFnsigma_kaonHtof, &b_RFnsigma_kaonHtof);
   fChain->SetBranchAddress("RFnsigma_pionHtof", &RFnsigma_pionHtof, &b_RFnsigma_pionHtof);
   fChain->SetBranchAddress("RFnsigma_electronHtof", &RFnsigma_electronHtof, &b_RFnsigma_electronHtof);
   fChain->SetBranchAddress("RFXiflag", &RFXiflag, &b_RFXiflag);
   fChain->SetBranchAddress("RFXiRefitflag", &RFXiRefitflag, &b_RFXiRefitflag);
   fChain->SetBranchAddress("RFXiPflag", &RFXiPflag, &b_RFXiPflag);
   fChain->SetBranchAddress("RFXiMass", &RFXiMass, &b_RFXiMass);
   fChain->SetBranchAddress("RFXiDecayVtx_x", &RFXiDecayVtx_x, &b_RFXiDecayVtx_x);
   fChain->SetBranchAddress("RFXiDecayVtx_y", &RFXiDecayVtx_y, &b_RFXiDecayVtx_y);
   fChain->SetBranchAddress("RFXiDecayVtx_z", &RFXiDecayVtx_z, &b_RFXiDecayVtx_z);
   fChain->SetBranchAddress("RFXiMom", &RFXiMom, &b_RFXiMom);
   fChain->SetBranchAddress("RFXiMom_x", &RFXiMom_x, &b_RFXiMom_x);
   fChain->SetBranchAddress("RFXiMom_y", &RFXiMom_y, &b_RFXiMom_y);
   fChain->SetBranchAddress("RFXiMom_z", &RFXiMom_z, &b_RFXiMom_z);
   fChain->SetBranchAddress("RFXiVtxCloseDist", &RFXiVtxCloseDist, &b_RFXiVtxCloseDist);
   fChain->SetBranchAddress("RFLambdaMass", &RFLambdaMass, &b_RFLambdaMass);
   fChain->SetBranchAddress("RFLambdaDecayVtx_x", &RFLambdaDecayVtx_x, &b_RFLambdaDecayVtx_x);
   fChain->SetBranchAddress("RFLambdaDecayVtx_y", &RFLambdaDecayVtx_y, &b_RFLambdaDecayVtx_y);
   fChain->SetBranchAddress("RFLambdaDecayVtx_z", &RFLambdaDecayVtx_z, &b_RFLambdaDecayVtx_z);
   fChain->SetBranchAddress("RFLambdaMom", &RFLambdaMom, &b_RFLambdaMom);
   fChain->SetBranchAddress("RFLambdaMom_x", &RFLambdaMom_x, &b_RFLambdaMom_x);
   fChain->SetBranchAddress("RFLambdaMom_y", &RFLambdaMom_y, &b_RFLambdaMom_y);
   fChain->SetBranchAddress("RFLambdaMom_z", &RFLambdaMom_z, &b_RFLambdaMom_z);
   fChain->SetBranchAddress("RFLambdaVtxCloseDist", &RFLambdaVtxCloseDist, &b_RFLambdaVtxCloseDist);
   fChain->SetBranchAddress("RFXiTargetVtx_x", &RFXiTargetVtx_x, &b_RFXiTargetVtx_x);
   fChain->SetBranchAddress("RFXiTargetVtx_y", &RFXiTargetVtx_y, &b_RFXiTargetVtx_y);
   fChain->SetBranchAddress("RFXiTargetVtx_z", &RFXiTargetVtx_z, &b_RFXiTargetVtx_z);
   fChain->SetBranchAddress("RFXiTargetMom", &RFXiTargetMom, &b_RFXiTargetMom);
   fChain->SetBranchAddress("RFXiTargetMom_x", &RFXiTargetMom_x, &b_RFXiTargetMom_x);
   fChain->SetBranchAddress("RFXiTargetMom_y", &RFXiTargetMom_y, &b_RFXiTargetMom_y);
   fChain->SetBranchAddress("RFXiTargetMom_z", &RFXiTargetMom_z, &b_RFXiTargetMom_z);
   fChain->SetBranchAddress("RFXiTargetCloseDist_dist", &RFXiTargetCloseDist_dist, &b_RFXiTargetCloseDist_dist);
   fChain->SetBranchAddress("RFLflag", &RFLflag, &b_RFLflag);
   fChain->SetBranchAddress("RFLambdaTargetCloseDist_dist", &RFLambdaTargetCloseDist_dist, &b_RFLambdaTargetCloseDist_dist);
   fChain->SetBranchAddress("RFLambdaTargetCloseVtx_x", &RFLambdaTargetCloseVtx_x, &b_RFLambdaTargetCloseVtx_x);
   fChain->SetBranchAddress("RFLambdaTargetCloseVtx_y", &RFLambdaTargetCloseVtx_y, &b_RFLambdaTargetCloseVtx_y);
   fChain->SetBranchAddress("RFLambdaTargetCloseVtx_z", &RFLambdaTargetCloseVtx_z, &b_RFLambdaTargetCloseVtx_z);
   fChain->SetBranchAddress("RFGFXiMass", &RFGFXiMass, &b_RFGFXiMass);
   fChain->SetBranchAddress("RFGFXiDecayVtx_x", &RFGFXiDecayVtx_x, &b_RFGFXiDecayVtx_x);
   fChain->SetBranchAddress("RFGFXiDecayVtx_y", &RFGFXiDecayVtx_y, &b_RFGFXiDecayVtx_y);
   fChain->SetBranchAddress("RFGFXiDecayVtx_z", &RFGFXiDecayVtx_z, &b_RFGFXiDecayVtx_z);
   fChain->SetBranchAddress("RFGFXiMom", &RFGFXiMom, &b_RFGFXiMom);
   fChain->SetBranchAddress("RFGFXiMom_x", &RFGFXiMom_x, &b_RFGFXiMom_x);
   fChain->SetBranchAddress("RFGFXiMom_y", &RFGFXiMom_y, &b_RFGFXiMom_y);
   fChain->SetBranchAddress("RFGFXiMom_z", &RFGFXiMom_z, &b_RFGFXiMom_z);
   fChain->SetBranchAddress("RFGFXiVtxCloseDist", &RFGFXiVtxCloseDist, &b_RFGFXiVtxCloseDist);
   fChain->SetBranchAddress("RFGFXiKKVtx_x", &RFGFXiKKVtx_x, &b_RFGFXiKKVtx_x);
   fChain->SetBranchAddress("RFGFXiKKVtx_y", &RFGFXiKKVtx_y, &b_RFGFXiKKVtx_y);
   fChain->SetBranchAddress("RFGFXiKKVtx_z", &RFGFXiKKVtx_z, &b_RFGFXiKKVtx_z);
   fChain->SetBranchAddress("RFGFXiKKVtxMom", &RFGFXiKKVtxMom, &b_RFGFXiKKVtxMom);
   fChain->SetBranchAddress("RFGFXiKKVtxMom_x", &RFGFXiKKVtxMom_x, &b_RFGFXiKKVtxMom_x);
   fChain->SetBranchAddress("RFGFXiKKVtxMom_y", &RFGFXiKKVtxMom_y, &b_RFGFXiKKVtxMom_y);
   fChain->SetBranchAddress("RFGFXiKKVtxMom_z", &RFGFXiKKVtxMom_z, &b_RFGFXiKKVtxMom_z);
   fChain->SetBranchAddress("RFGFXiKKVtxCloseDist", &RFGFXiKKVtxCloseDist, &b_RFGFXiKKVtxCloseDist);
   fChain->SetBranchAddress("RFGFXiProductionVtx_x", &RFGFXiProductionVtx_x, &b_RFGFXiProductionVtx_x);
   fChain->SetBranchAddress("RFGFXiProductionVtx_y", &RFGFXiProductionVtx_y, &b_RFGFXiProductionVtx_y);
   fChain->SetBranchAddress("RFGFXiProductionVtx_z", &RFGFXiProductionVtx_z, &b_RFGFXiProductionVtx_z);
   fChain->SetBranchAddress("RFGFXiProductionVtxMom", &RFGFXiProductionVtxMom, &b_RFGFXiProductionVtxMom);
   fChain->SetBranchAddress("RFGFXiProductionVtxMom_x", &RFGFXiProductionVtxMom_x, &b_RFGFXiProductionVtxMom_x);
   fChain->SetBranchAddress("RFGFXiProductionVtxMom_y", &RFGFXiProductionVtxMom_y, &b_RFGFXiProductionVtxMom_y);
   fChain->SetBranchAddress("RFGFXiProductionVtxMom_z", &RFGFXiProductionVtxMom_z, &b_RFGFXiProductionVtxMom_z);
   fChain->SetBranchAddress("RFGFXiProductionVtxCloseDist", &RFGFXiProductionVtxCloseDist, &b_RFGFXiProductionVtxCloseDist);
   fChain->SetBranchAddress("RFGFXiTrackLen", &RFGFXiTrackLen, &b_RFGFXiTrackLen);
   fChain->SetBranchAddress("RFGFXiTof", &RFGFXiTof, &b_RFGFXiTof);
   fChain->SetBranchAddress("RFGFXiMomLoss", &RFGFXiMomLoss, &b_RFGFXiMomLoss);
   fChain->SetBranchAddress("RFGFXiExcitation", &RFGFXiExcitation, &b_RFGFXiExcitation);
   fChain->SetBranchAddress("RFGFXiTarget_x", &RFGFXiTarget_x, &b_RFGFXiTarget_x);
   fChain->SetBranchAddress("RFGFXiTarget_y", &RFGFXiTarget_y, &b_RFGFXiTarget_y);
   fChain->SetBranchAddress("RFGFXiTarget_z", &RFGFXiTarget_z, &b_RFGFXiTarget_z);
   fChain->SetBranchAddress("RFGFXiTargetMom", &RFGFXiTargetMom, &b_RFGFXiTargetMom);
   fChain->SetBranchAddress("RFGFXiTargetMom_x", &RFGFXiTargetMom_x, &b_RFGFXiTargetMom_x);
   fChain->SetBranchAddress("RFGFXiTargetMom_y", &RFGFXiTargetMom_y, &b_RFGFXiTargetMom_y);
   fChain->SetBranchAddress("RFGFXiTargetMom_z", &RFGFXiTargetMom_z, &b_RFGFXiTargetMom_z);
   fChain->SetBranchAddress("RFGFXiTargetCloseDist", &RFGFXiTargetCloseDist, &b_RFGFXiTargetCloseDist);
   fChain->SetBranchAddress("RFGFXiTargetCenter_x", &RFGFXiTargetCenter_x, &b_RFGFXiTargetCenter_x);
   fChain->SetBranchAddress("RFGFXiTargetCenter_y", &RFGFXiTargetCenter_y, &b_RFGFXiTargetCenter_y);
   fChain->SetBranchAddress("RFGFXiTargetCenter_z", &RFGFXiTargetCenter_z, &b_RFGFXiTargetCenter_z);
   fChain->SetBranchAddress("RFGFXiTargetCenterMom", &RFGFXiTargetCenterMom, &b_RFGFXiTargetCenterMom);
   fChain->SetBranchAddress("RFGFXiTargetCenterMom_x", &RFGFXiTargetCenterMom_x, &b_RFGFXiTargetCenterMom_x);
   fChain->SetBranchAddress("RFGFXiTargetCenterMom_y", &RFGFXiTargetCenterMom_y, &b_RFGFXiTargetCenterMom_y);
   fChain->SetBranchAddress("RFGFXiTargetCenterMom_z", &RFGFXiTargetCenterMom_z, &b_RFGFXiTargetCenterMom_z);
   fChain->SetBranchAddress("RFGFXiTargetCenterCloseDist", &RFGFXiTargetCenterCloseDist, &b_RFGFXiTargetCenterCloseDist);
   fChain->SetBranchAddress("RFGFLambdaMass", &RFGFLambdaMass, &b_RFGFLambdaMass);
   fChain->SetBranchAddress("RFGFLambdaDecayVtx_x", &RFGFLambdaDecayVtx_x, &b_RFGFLambdaDecayVtx_x);
   fChain->SetBranchAddress("RFGFLambdaDecayVtx_y", &RFGFLambdaDecayVtx_y, &b_RFGFLambdaDecayVtx_y);
   fChain->SetBranchAddress("RFGFLambdaDecayVtx_z", &RFGFLambdaDecayVtx_z, &b_RFGFLambdaDecayVtx_z);
   fChain->SetBranchAddress("RFGFLambdaMom", &RFGFLambdaMom, &b_RFGFLambdaMom);
   fChain->SetBranchAddress("RFGFLambdaMom_x", &RFGFLambdaMom_x, &b_RFGFLambdaMom_x);
   fChain->SetBranchAddress("RFGFLambdaMom_y", &RFGFLambdaMom_y, &b_RFGFLambdaMom_y);
   fChain->SetBranchAddress("RFGFLambdaMom_z", &RFGFLambdaMom_z, &b_RFGFLambdaMom_z);
   fChain->SetBranchAddress("RFGFLambdaVtxCloseDist", &RFGFLambdaVtxCloseDist, &b_RFGFLambdaVtxCloseDist);
   fChain->SetBranchAddress("RFGFLambdaTargetCloseDist", &RFGFLambdaTargetCloseDist, &b_RFGFLambdaTargetCloseDist);
   fChain->SetBranchAddress("RFGFLambdaTarget_x", &RFGFLambdaTarget_x, &b_RFGFLambdaTarget_x);
   fChain->SetBranchAddress("RFGFLambdaTarget_y", &RFGFLambdaTarget_y, &b_RFGFLambdaTarget_y);
   fChain->SetBranchAddress("RFGFLambdaTarget_z", &RFGFLambdaTarget_z, &b_RFGFLambdaTarget_z);
   fChain->SetBranchAddress("RFGFLambdaTargetCenter_x", &RFGFLambdaTargetCenter_x, &b_RFGFLambdaTargetCenter_x);
   fChain->SetBranchAddress("RFGFLambdaTargetCenter_y", &RFGFLambdaTargetCenter_y, &b_RFGFLambdaTargetCenter_y);
   fChain->SetBranchAddress("RFGFLambdaTargetCenter_z", &RFGFLambdaTargetCenter_z, &b_RFGFLambdaTargetCenter_z);
   fChain->SetBranchAddress("RFGFLambdaTargetCenterCloseDist", &RFGFLambdaTargetCenterCloseDist, &b_RFGFLambdaTargetCenterCloseDist);
   fChain->SetBranchAddress("RFGFLambdaProductionVtx_x", &RFGFLambdaProductionVtx_x, &b_RFGFLambdaProductionVtx_x);
   fChain->SetBranchAddress("RFGFLambdaProductionVtx_y", &RFGFLambdaProductionVtx_y, &b_RFGFLambdaProductionVtx_y);
   fChain->SetBranchAddress("RFGFLambdaProductionVtx_z", &RFGFLambdaProductionVtx_z, &b_RFGFLambdaProductionVtx_z);
   fChain->SetBranchAddress("RFGFLambdaProductionVtxCloseDist", &RFGFLambdaProductionVtxCloseDist, &b_RFGFLambdaProductionVtxCloseDist);
   fChain->SetBranchAddress("RFGFLambdaTrackLen", &RFGFLambdaTrackLen, &b_RFGFLambdaTrackLen);
   fChain->SetBranchAddress("RFGFLambdaTof", &RFGFLambdaTof, &b_RFGFLambdaTof);
   fChain->SetBranchAddress("RFXiDecaysTrackId", &RFXiDecaysTrackId, &b_RFXiDecaysTrackId);
   fChain->SetBranchAddress("RFXiDecaysPurity", &RFXiDecaysPurity, &b_RFXiDecaysPurity);
   fChain->SetBranchAddress("RFXiDecaysEfficiency", &RFXiDecaysEfficiency, &b_RFXiDecaysEfficiency);
   fChain->SetBranchAddress("RFXiDecaysG4tid", &RFXiDecaysG4tid, &b_RFXiDecaysG4tid);
   fChain->SetBranchAddress("RFXiDecaysMom", &RFXiDecaysMom, &b_RFXiDecaysMom);
   fChain->SetBranchAddress("RFXiDecaysMom_x", &RFXiDecaysMom_x, &b_RFXiDecaysMom_x);
   fChain->SetBranchAddress("RFXiDecaysMom_y", &RFXiDecaysMom_y, &b_RFXiDecaysMom_y);
   fChain->SetBranchAddress("RFXiDecaysMom_z", &RFXiDecaysMom_z, &b_RFXiDecaysMom_z);
   fChain->SetBranchAddress("RFXiRefitDist_p_xz", &RFXiRefitDist_p_xz, &b_RFXiRefitDist_p_xz);
   fChain->SetBranchAddress("RFXiRefitDist_p_y", &RFXiRefitDist_p_y, &b_RFXiRefitDist_p_y);
   fChain->SetBranchAddress("RFXiRefitDist_pi1_xz", &RFXiRefitDist_pi1_xz, &b_RFXiRefitDist_pi1_xz);
   fChain->SetBranchAddress("RFXiRefitDist_pi1_y", &RFXiRefitDist_pi1_y, &b_RFXiRefitDist_pi1_y);
   fChain->SetBranchAddress("RFXiRefitDist_pi2_xz", &RFXiRefitDist_pi2_xz, &b_RFXiRefitDist_pi2_xz);
   fChain->SetBranchAddress("RFXiRefitDist_pi2_y", &RFXiRefitDist_pi2_y, &b_RFXiRefitDist_pi2_y);
   fChain->SetBranchAddress("RFXiRefitDist_xi_xz", &RFXiRefitDist_xi_xz, &b_RFXiRefitDist_xi_xz);
   fChain->SetBranchAddress("RFXiRefitDist_xi_y", &RFXiRefitDist_xi_y, &b_RFXiRefitDist_xi_y);
   fChain->SetBranchAddress("RFGFXiDecaysNhit", &RFGFXiDecaysNhit, &b_RFGFXiDecaysNhit);
   fChain->SetBranchAddress("RFGFXiDecaysChisqr", &RFGFXiDecaysChisqr, &b_RFGFXiDecaysChisqr);
   fChain->SetBranchAddress("RFGFXiDecaysCharge", &RFGFXiDecaysCharge, &b_RFGFXiDecaysCharge);
   fChain->SetBranchAddress("RFGFXiDecaysTof", &RFGFXiDecaysTof, &b_RFGFXiDecaysTof);
   fChain->SetBranchAddress("RFGFXiDecaysPval", &RFGFXiDecaysPval, &b_RFGFXiDecaysPval);
   fChain->SetBranchAddress("RFGFXiDecaysPdgcode", &RFGFXiDecaysPdgcode, &b_RFGFXiDecaysPdgcode);
   fChain->SetBranchAddress("RFGFXiDecaysHtofId", &RFGFXiDecaysHtofId, &b_RFGFXiDecaysHtofId);
   fChain->SetBranchAddress("RFGFXiDecaysTrackLen", &RFGFXiDecaysTrackLen, &b_RFGFXiDecaysTrackLen);
   fChain->SetBranchAddress("RFGFXiDecaysTrackTof", &RFGFXiDecaysTrackTof, &b_RFGFXiDecaysTrackTof);
   fChain->SetBranchAddress("RFGFXiDecaysMassSquare", &RFGFXiDecaysMassSquare, &b_RFGFXiDecaysMassSquare);
   fChain->SetBranchAddress("RFGFXiDecaysInvbeta", &RFGFXiDecaysInvbeta, &b_RFGFXiDecaysInvbeta);
   fChain->SetBranchAddress("RFGFXiDecaysMom", &RFGFXiDecaysMom, &b_RFGFXiDecaysMom);
   fChain->SetBranchAddress("RFGFXiDecaysMom_x", &RFGFXiDecaysMom_x, &b_RFGFXiDecaysMom_x);
   fChain->SetBranchAddress("RFGFXiDecaysMom_y", &RFGFXiDecaysMom_y, &b_RFGFXiDecaysMom_y);
   fChain->SetBranchAddress("RFGFXiDecaysMom_z", &RFGFXiDecaysMom_z, &b_RFGFXiDecaysMom_z);
   fChain->SetBranchAddress("RFGFXiDecaysMomCM", &RFGFXiDecaysMomCM, &b_RFGFXiDecaysMomCM);
   fChain->SetBranchAddress("RFGFXiDecaysMomCM_x", &RFGFXiDecaysMomCM_x, &b_RFGFXiDecaysMomCM_x);
   fChain->SetBranchAddress("RFGFXiDecaysMomCM_y", &RFGFXiDecaysMomCM_y, &b_RFGFXiDecaysMomCM_y);
   fChain->SetBranchAddress("RFGFXiDecaysMomCM_z", &RFGFXiDecaysMomCM_z, &b_RFGFXiDecaysMomCM_z);
   fChain->SetBranchAddress("RFGFXiDecaysMomLoss", &RFGFXiDecaysMomLoss, &b_RFGFXiDecaysMomLoss);
   fChain->SetBranchAddress("RFGFXiDecaysELoss", &RFGFXiDecaysELoss, &b_RFGFXiDecaysELoss);
   fChain->SetBranchAddress("RFAccidentalMultiplicity", &RFAccidentalMultiplicity, &b_RFAccidentalMultiplicity);
   fChain->SetBranchAddress("RFAccidentalTrackId", &RFAccidentalTrackId, &b_RFAccidentalTrackId);
   fChain->SetBranchAddress("RFXiResidualsMultiplicity", &RFXiResidualsMultiplicity, &b_RFXiResidualsMultiplicity);
   fChain->SetBranchAddress("RFXipMultiplicity", &RFXipMultiplicity, &b_RFXipMultiplicity);
   fChain->SetBranchAddress("RFXipipMultiplicity", &RFXipipMultiplicity, &b_RFXipipMultiplicity);
   fChain->SetBranchAddress("RFXipimMultiplicity", &RFXipimMultiplicity, &b_RFXipimMultiplicity);
   fChain->SetBranchAddress("RFXiepMultiplicity", &RFXiepMultiplicity, &b_RFXiepMultiplicity);
   fChain->SetBranchAddress("RFXiemMultiplicity", &RFXiemMultiplicity, &b_RFXiemMultiplicity);
   fChain->SetBranchAddress("RFXippipMultiplicity", &RFXippipMultiplicity, &b_RFXippipMultiplicity);
   fChain->SetBranchAddress("RFXiResidualsTrackId", &RFXiResidualsTrackId, &b_RFXiResidualsTrackId);
   fChain->SetBranchAddress("RFXiResidualsMassSquare", &RFXiResidualsMassSquare, &b_RFXiResidualsMassSquare);
   fChain->SetBranchAddress("RFXiResidualsInvbeta", &RFXiResidualsInvbeta, &b_RFXiResidualsInvbeta);
   fChain->SetBranchAddress("RFXiResidualsCloseDistTgt", &RFXiResidualsCloseDistTgt, &b_RFXiResidualsCloseDistTgt);
   fChain->SetBranchAddress("RFXiResidualsGFProductionVtxCloseDist", &RFXiResidualsGFProductionVtxCloseDist, &b_RFXiResidualsGFProductionVtxCloseDist);
   fChain->SetBranchAddress("RFXiResidualsGFProductionVtx_x", &RFXiResidualsGFProductionVtx_x, &b_RFXiResidualsGFProductionVtx_x);
   fChain->SetBranchAddress("RFXiResidualsGFProductionVtx_y", &RFXiResidualsGFProductionVtx_y, &b_RFXiResidualsGFProductionVtx_y);
   fChain->SetBranchAddress("RFXiResidualsGFProductionVtx_z", &RFXiResidualsGFProductionVtx_z, &b_RFXiResidualsGFProductionVtx_z);
   fChain->SetBranchAddress("RFXiResidualsGFProductionMom", &RFXiResidualsGFProductionMom, &b_RFXiResidualsGFProductionMom);
   fChain->SetBranchAddress("RFXiResidualsGFProductionMom_x", &RFXiResidualsGFProductionMom_x, &b_RFXiResidualsGFProductionMom_x);
   fChain->SetBranchAddress("RFXiResidualsGFProductionMom_y", &RFXiResidualsGFProductionMom_y, &b_RFXiResidualsGFProductionMom_y);
   fChain->SetBranchAddress("RFXiResidualsGFProductionMom_z", &RFXiResidualsGFProductionMom_z, &b_RFXiResidualsGFProductionMom_z);
   fChain->SetBranchAddress("RFXiResidualsKFProductionVtxCloseDist", &RFXiResidualsKFProductionVtxCloseDist, &b_RFXiResidualsKFProductionVtxCloseDist);
   fChain->SetBranchAddress("RFXiResidualsKFProductionVtx_x", &RFXiResidualsKFProductionVtx_x, &b_RFXiResidualsKFProductionVtx_x);
   fChain->SetBranchAddress("RFXiResidualsKFProductionVtx_y", &RFXiResidualsKFProductionVtx_y, &b_RFXiResidualsKFProductionVtx_y);
   fChain->SetBranchAddress("RFXiResidualsKFProductionVtx_z", &RFXiResidualsKFProductionVtx_z, &b_RFXiResidualsKFProductionVtx_z);
   fChain->SetBranchAddress("RFXiResidualsKFProductionMom", &RFXiResidualsKFProductionMom, &b_RFXiResidualsKFProductionMom);
   fChain->SetBranchAddress("RFXiResidualsKFProductionMom_x", &RFXiResidualsKFProductionMom_x, &b_RFXiResidualsKFProductionMom_x);
   fChain->SetBranchAddress("RFXiResidualsKFProductionMom_y", &RFXiResidualsKFProductionMom_y, &b_RFXiResidualsKFProductionMom_y);
   fChain->SetBranchAddress("RFXiResidualsKFProductionMom_z", &RFXiResidualsKFProductionMom_z, &b_RFXiResidualsKFProductionMom_z);
   fChain->SetBranchAddress("RFXiResidualsMom", &RFXiResidualsMom, &b_RFXiResidualsMom);
   fChain->SetBranchAddress("RFXiResidualsMom_x", &RFXiResidualsMom_x, &b_RFXiResidualsMom_x);
   fChain->SetBranchAddress("RFXiResidualsMom_y", &RFXiResidualsMom_y, &b_RFXiResidualsMom_y);
   fChain->SetBranchAddress("RFXiResidualsMom_z", &RFXiResidualsMom_z, &b_RFXiResidualsMom_z);
   fChain->SetBranchAddress("RFXiResidualsCharge", &RFXiResidualsCharge, &b_RFXiResidualsCharge);
   fChain->SetBranchAddress("RFKFLambdaMom", &RFKFLambdaMom, &b_RFKFLambdaMom);
   fChain->SetBranchAddress("RFKFLambdaMom_x", &RFKFLambdaMom_x, &b_RFKFLambdaMom_x);
   fChain->SetBranchAddress("RFKFLambdaMom_y", &RFKFLambdaMom_y, &b_RFKFLambdaMom_y);
   fChain->SetBranchAddress("RFKFLambdaMom_z", &RFKFLambdaMom_z, &b_RFKFLambdaMom_z);
   fChain->SetBranchAddress("RFKFLambdaChisqr", &RFKFLambdaChisqr, &b_RFKFLambdaChisqr);
   fChain->SetBranchAddress("RFKFLambdaPval", &RFKFLambdaPval, &b_RFKFLambdaPval);
   fChain->SetBranchAddress("RFKFLambdaPull", &RFKFLambdaPull, &b_RFKFLambdaPull);
   fChain->SetBranchAddress("RFKFLambdaCovMatrix", &RFKFLambdaCovMatrix, &b_RFKFLambdaCovMatrix);
   fChain->SetBranchAddress("RFKFXiVtxCloseDist", &RFKFXiVtxCloseDist, &b_RFKFXiVtxCloseDist);
   fChain->SetBranchAddress("RFKFXiMom", &RFKFXiMom, &b_RFKFXiMom);
   fChain->SetBranchAddress("RFKFXiMom_x", &RFKFXiMom_x, &b_RFKFXiMom_x);
   fChain->SetBranchAddress("RFKFXiMom_y", &RFKFXiMom_y, &b_RFKFXiMom_y);
   fChain->SetBranchAddress("RFKFXiMom_z", &RFKFXiMom_z, &b_RFKFXiMom_z);
   fChain->SetBranchAddress("RFKFXiChisqr", &RFKFXiChisqr, &b_RFKFXiChisqr);
   fChain->SetBranchAddress("RFKFXiPval", &RFKFXiPval, &b_RFKFXiPval);
   fChain->SetBranchAddress("RFKFXiMass", &RFKFXiMass, &b_RFKFXiMass);
   fChain->SetBranchAddress("RFKFXiDecayVtx_x", &RFKFXiDecayVtx_x, &b_RFKFXiDecayVtx_x);
   fChain->SetBranchAddress("RFKFXiDecayVtx_y", &RFKFXiDecayVtx_y, &b_RFKFXiDecayVtx_y);
   fChain->SetBranchAddress("RFKFXiDecayVtx_z", &RFKFXiDecayVtx_z, &b_RFKFXiDecayVtx_z);
   fChain->SetBranchAddress("RFKFXiPull", &RFKFXiPull, &b_RFKFXiPull);
   fChain->SetBranchAddress("RFKFXiCovMatrix", &RFKFXiCovMatrix, &b_RFKFXiCovMatrix);
   fChain->SetBranchAddress("RFKFKKXiProductionVtxChisqr", &RFKFKKXiProductionVtxChisqr, &b_RFKFKKXiProductionVtxChisqr);
   fChain->SetBranchAddress("RFKFKKXiProductionVtx_x", &RFKFKKXiProductionVtx_x, &b_RFKFKKXiProductionVtx_x);
   fChain->SetBranchAddress("RFKFKKXiProductionVtx_y", &RFKFKKXiProductionVtx_y, &b_RFKFKKXiProductionVtx_y);
   fChain->SetBranchAddress("RFKFKKXiProductionVtx_z", &RFKFKKXiProductionVtx_z, &b_RFKFKKXiProductionVtx_z);
   fChain->SetBranchAddress("RFKFXiProductionVtx_x", &RFKFXiProductionVtx_x, &b_RFKFXiProductionVtx_x);
   fChain->SetBranchAddress("RFKFXiProductionVtx_y", &RFKFXiProductionVtx_y, &b_RFKFXiProductionVtx_y);
   fChain->SetBranchAddress("RFKFXiProductionVtx_z", &RFKFXiProductionVtx_z, &b_RFKFXiProductionVtx_z);
   fChain->SetBranchAddress("RFKFXiProductionVtxMom", &RFKFXiProductionVtxMom, &b_RFKFXiProductionVtxMom);
   fChain->SetBranchAddress("RFKFXiProductionVtxMom_x", &RFKFXiProductionVtxMom_x, &b_RFKFXiProductionVtxMom_x);
   fChain->SetBranchAddress("RFKFXiProductionVtxMom_y", &RFKFXiProductionVtxMom_y, &b_RFKFXiProductionVtxMom_y);
   fChain->SetBranchAddress("RFKFXiProductionVtxMom_z", &RFKFXiProductionVtxMom_z, &b_RFKFXiProductionVtxMom_z);
   fChain->SetBranchAddress("RFKFXiProductionVtxCloseDist", &RFKFXiProductionVtxCloseDist, &b_RFKFXiProductionVtxCloseDist);
   fChain->SetBranchAddress("RFKFXiTrackLen", &RFKFXiTrackLen, &b_RFKFXiTrackLen);
   fChain->SetBranchAddress("RFKFXiTof", &RFKFXiTof, &b_RFKFXiTof);
   fChain->SetBranchAddress("RFKFXiMomLoss", &RFKFXiMomLoss, &b_RFKFXiMomLoss);
   fChain->SetBranchAddress("RFKFXiExcitation", &RFKFXiExcitation, &b_RFKFXiExcitation);
   fChain->SetBranchAddress("RFKFKpXiProductionVtx_x", &RFKFKpXiProductionVtx_x, &b_RFKFKpXiProductionVtx_x);
   fChain->SetBranchAddress("RFKFKpXiProductionVtx_y", &RFKFKpXiProductionVtx_y, &b_RFKFKpXiProductionVtx_y);
   fChain->SetBranchAddress("RFKFKpXiProductionVtx_z", &RFKFKpXiProductionVtx_z, &b_RFKFKpXiProductionVtx_z);
   fChain->SetBranchAddress("RFKFXiProductionVtx_x_KpXi", &RFKFXiProductionVtx_x_KpXi, &b_RFKFXiProductionVtx_x_KpXi);
   fChain->SetBranchAddress("RFKFXiProductionVtx_y_KpXi", &RFKFXiProductionVtx_y_KpXi, &b_RFKFXiProductionVtx_y_KpXi);
   fChain->SetBranchAddress("RFKFXiProductionVtx_z_KpXi", &RFKFXiProductionVtx_z_KpXi, &b_RFKFXiProductionVtx_z_KpXi);
   fChain->SetBranchAddress("RFKFXiProductionVtxMom_KpXi", &RFKFXiProductionVtxMom_KpXi, &b_RFKFXiProductionVtxMom_KpXi);
   fChain->SetBranchAddress("RFKFXiProductionVtxMom_x_KpXi", &RFKFXiProductionVtxMom_x_KpXi, &b_RFKFXiProductionVtxMom_x_KpXi);
   fChain->SetBranchAddress("RFKFXiProductionVtxMom_y_KpXi", &RFKFXiProductionVtxMom_y_KpXi, &b_RFKFXiProductionVtxMom_y_KpXi);
   fChain->SetBranchAddress("RFKFXiProductionVtxMom_z_KpXi", &RFKFXiProductionVtxMom_z_KpXi, &b_RFKFXiProductionVtxMom_z_KpXi);
   fChain->SetBranchAddress("RFKFXiProductionVtxCloseDist_KpXi", &RFKFXiProductionVtxCloseDist_KpXi, &b_RFKFXiProductionVtxCloseDist_KpXi);
   fChain->SetBranchAddress("RFKFXiProductionVtx_x_KK", &RFKFXiProductionVtx_x_KK, &b_RFKFXiProductionVtx_x_KK);
   fChain->SetBranchAddress("RFKFXiProductionVtx_y_KK", &RFKFXiProductionVtx_y_KK, &b_RFKFXiProductionVtx_y_KK);
   fChain->SetBranchAddress("RFKFXiProductionVtx_z_KK", &RFKFXiProductionVtx_z_KK, &b_RFKFXiProductionVtx_z_KK);
   fChain->SetBranchAddress("RFKFXiProductionVtxMom_KK", &RFKFXiProductionVtxMom_KK, &b_RFKFXiProductionVtxMom_KK);
   fChain->SetBranchAddress("RFKFXiProductionVtxMom_x_KK", &RFKFXiProductionVtxMom_x_KK, &b_RFKFXiProductionVtxMom_x_KK);
   fChain->SetBranchAddress("RFKFXiProductionVtxMom_y_KK", &RFKFXiProductionVtxMom_y_KK, &b_RFKFXiProductionVtxMom_y_KK);
   fChain->SetBranchAddress("RFKFXiProductionVtxMom_z_KK", &RFKFXiProductionVtxMom_z_KK, &b_RFKFXiProductionVtxMom_z_KK);
   fChain->SetBranchAddress("RFKFXiProductionVtxCloseDist_KK", &RFKFXiProductionVtxCloseDist_KK, &b_RFKFXiProductionVtxCloseDist_KK);
   fChain->SetBranchAddress("RFKFXiDecaysMom", &RFKFXiDecaysMom, &b_RFKFXiDecaysMom);
   fChain->SetBranchAddress("RFKFXiDecaysMom_x", &RFKFXiDecaysMom_x, &b_RFKFXiDecaysMom_x);
   fChain->SetBranchAddress("RFKFXiDecaysMom_y", &RFKFXiDecaysMom_y, &b_RFKFXiDecaysMom_y);
   fChain->SetBranchAddress("RFKFXiDecaysMom_z", &RFKFXiDecaysMom_z, &b_RFKFXiDecaysMom_z);
   Notify();
}

bool g4refitcarbon::Notify()
{
...
void g4refitcarbon::Show(Long64_t entry)
{
...
Int_t g4refitcarbon::Cut(Long64_t entry)
{
