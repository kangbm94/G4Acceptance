...
// Tue Jul  8 21:43:10 2025 by ROOT version 6.32.06
// from TTree tpc/tree of GenfitCarbon
// found on file: ../../genfitfiles/Prod/250704_GenfitCarbonVer9_ProdSummary.root
//////////////////////////////////////////////////////////

#ifndef genfitcarbon_h
#define genfitcarbon_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   genfitcarbon(TTree *tree=0);
   virtual ~genfitcarbon();
...
genfitcarbon::genfitcarbon(TTree *tree) : fChain(0) 
{
...
genfitcarbon::~genfitcarbon()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t genfitcarbon::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t genfitcarbon::LoadTree(Long64_t entry)
{
...
void genfitcarbon::Init(TTree *tree)
{
...
void genfitcarbon::Show(Long64_t entry)
{
...
Int_t genfitcarbon::Cut(Long64_t entry)
{
