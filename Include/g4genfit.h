...
// Mon Apr 28 14:40:01 2025 by ROOT version 6.32.06
// from TTree tpc/tree of GenfitCarbon
// found on file: WOBeam/KpXiMM_1_GenfitCarbonGeant4.root
//////////////////////////////////////////////////////////
...
g4genfit::g4genfit(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("WOBeam/KpXiMM_1_GenfitCarbonGeant4.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("WOBeam/KpXiMM_1_GenfitCarbonGeant4.root");
      }
...
Int_t g4genfit::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t g4genfit::LoadTree(Long64_t entry)
{
...
void g4genfit::Show(Long64_t entry)
{
...
Int_t g4genfit::Cut(Long64_t entry)
{
